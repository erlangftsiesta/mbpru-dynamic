...
if (function(a, e, s, n) {
    ...
    var r, o, l, d = {}, t = "scrollbar", i = "owl-scroll-handle", c = "owl-scroll-handle-dragged", u = a("<div>").addClass(i), h = a("<div>").addClass("owl-scroll-progress"), p = a("<div>").addClass("owl-scrollbar").append(u), f = new H(p[0]), g = new H(u[0]), m = new H(h[0]), v = 0, y = 0, w = "mousemove." + t + " mouseup." + t, _ = "touchmove." + t + " touchend." + t, b = "click." + t, x = ["INPUT", "SELECT", "BUTTON", "TEXTAREA"], T = ["overflow", "position"], C = ["position", "webkitTransform", "msTransform", "transform", "left", "top", "width", "height"], k = 0, S = 0, j = 1, L = 0, O = {
        ...
        cur: 0,
        index: 0
    }, R = Math.abs, I = Math.sqrt, A = Math.pow, Q = Math.round;
    Math.max,
    Math.min;
    !function() {
        ...
        this._handlers = {
            "initialized.owl.carousel refreshed.owl.carousel resized.owl.carousel": a.proxy(function(e) {
                e.namespace && this._core.settings.scrollbarType && function(e) {
                    ...
                    f.save.apply(f, T),
                    u.on("touchstart.scrollbar mousedown.scrollbar", {
                        source: i
                    }, M),
                    v = p.width(),
                    k = e.item.count,
                    ...
                    P.start = 0,
                    P.cur = 0,
                    "progress" === d.scrollbarType ? (p.prepend(h),
                    y = B(e.item.index),
                    t = u.width(),
                    m.save.apply(g, C),
                    h.width(y)) : (t = j,
            ...
            "drag.owl.carousel": a.proxy(function(e) {
                e.namespace && this._core.settings.scrollbarType && (O.init = 1,
                V.call(this, e))
            }, this),
    ...
    function D(e) {
        ...
        if (O.released || !(O.path < 1)) {
            if (!O.init) {
                if (O.path < d.scrollDragThreshold)
                    return O.released ? F() : n;
                if (!(R(O.pathX) > R(O.pathY)))
                    return F();
                O.init = 1
            }
            switch (W(e),
            !O.locked && O.path > O.pathToLock && O.slidee && (O.locked = 1,
            O.$source.on(b, E)),
            O.released && F(),
            d.scrollbarType) {
            case "scroll":
                t = N(O.delta, P.start, P.end),
                o ? u[0].style[o] = l + "translateX(" + t + "px)" : u[0].style.left = t + "px";
                break;
            case "progress":
                t = N(O.delta, P.start, P.end),
                h[0].style.width = t + "px",
                u[0].style.left = t + "px"
            }
            O.current = t;
            var i = Q(O.current / j);
            i != P.index && (P.index = i,
            r.$element.trigger("to.owl.carousel", [i, L, !0]))
        }
    }
    function F() {
        O.released = !0,
            ...
            save: function() {
                if (t && t.nodeType) {
                    for (var e = 0; e < arguments.length; e++)
                        i.style[arguments[e]] = t.style[arguments[e]];
                    return i
                }
            },
            restore: function() {
                if (t && t.nodeType) {
                    for (var e in i.style)
                        i.style.hasOwnProperty(e) && (t.style[e] = i.style[e]);
                    return i
                }
            }
        };
    ...
    function V(e) {
        ...
        if (u.length && 0 === O.init)
            ...
            d.scrollbarType) {
            case "scroll":
                t = 0 === (i = r.relative(r.current())) ? 0 : i < k - S ? j * i : v - j,
                P.cur = t,
                o ? u[0].style[o] = l + "translateX(" + t + "px)" : u[0].style.left = t + "px";
                break;
            case "progress":
        ...
        if (h(".charts").length) {
            ...
            i.utils = {
                ...
                rand: function(e, t) {
                    ...
                    return e = e === g ? 0 : e,
                    t = t === g ? 1 : t,
                    this._seed = (9301 * i + 49297) % 233280,
                    e + this._seed / 233280 * (t - e)
                },
                numbers: function(e) {
                    var t, i, a = e || {}, n = a.min || 0, r = a.max || 1, s = a.from || [], o = a.count || 8, l = a.decimals || 8, d = a.continuity || 1, c = Math.pow(10, l) || 0, u = [];
                    for (t = 0; t < o; ++t)
                        i = (s[t] || 0) + this.rand(n, r),
                        this.rand() <= d ? u.push(Math.round(c * i) / c) : u.push(null);
                    return u
                },
                labels: function(e) {
                    var t, i = e || {}, a = i.min || 0, n = i.max || 100, r = (n - a) / (i.count || 8), s = i.decimals || 8, o = Math.pow(10, s) || 0, l = i.prefix || "", d = [];
                    for (t = a; t < n; t += r)
                        d.push(l + Math.round(o * t) / o);
                    return d
                },
                months: function(e) {
                    var t, i, a = e || {}, n = a.count || 12, r = a.section, s = [];
                    for (t = 0; t < n; ++t)
                        i = o[Math.ceil(t) % 12],
                        s.push(i.substring(0, r));
                    return s
                },
                color: function(e) {
                    return t[e % t.length]
            ...
            f.getElementById("addDataset").addEventListener("click", function() {
                for (var e = s[r.data.datasets.length % s.length], t = p.chartColors[e], i = {
                    ...
                    data: [],
                    fill: !1
                }, a = 0; a < r.data.labels.length; ++a)
                    i.data.push(randomScalingFactor());
                r.data.datasets.push(i),
                p.myLine.update()
            }),
            ...
            f.getElementById("addData-bar").addEventListener("click", function() {
                if (0 < d.datasets.length) {
                    ...
                    d.labels.push(e);
                    for (var t = 0; t < d.datasets.length; ++t)
                        d.datasets[t].data.push(randomScalingFactor());
                    p.myBar.update()
                }
            }),
            ...
            f.getElementById("removeData-doughnut").addEventListener("click", function() {
                ...
                u.data.datasets.forEach(function(e) {
                    e.data.pop(),
                    e.backgroundColor.pop()
                }),
                p.myDoughnut.update()
            }),
            f.getElementById("changeCircleSize").addEventListener("click", function() {
                p.myDoughnut.options.circumference === Math.PI ? (p.myDoughnut.options.circumference = 2 * Math.PI,
                p.myDoughnut.options.rotation = -Math.PI / 2) : (p.myDoughnut.options.circumference = Math.PI,
                p.myDoughnut.options.rotation = -Math.PI),
                p.myDoughnut.update()
            }),
            p.onload = function() {
...
function(s, e, t, i) {
    ...
    s(t).ready(function() {
        ...
        e.hasClass("footer-reveal") && (t.length && i.length && (t.css("position", "fixed").css("bottom", i.height()),
        i.css("position", "fixed").css("bottom", 0)),
...
function(j, L, O, e) {
    ...
    j(O).ready(function() {
        var t, e = j(".current-year"), i = j(".video-back-vidbacking"), a = j(".video-back-vidbacking-muted"), n = j(".show-pageloader"), r = j(".notification"), s = j(".message"), o = j(".dropdown"), l = j(".show-modal"), d = j(".parallax-background"), c = j(".docs-content"), u = j("#back-to-top"), h = j(".sidebar-fixed"), p = j(".video-container"), f = j(".ajax-contact-form"), g = j(".overhang-message-content.success"), m = j(".overhang-message-content.error"), v = j("body"), y = new Date;
        if (e.length && e.text(y.getFullYear()),
        h.length && h.stickySidebar({
            topSpacing: 100,
            bottomSpacing: 100
        }),
        p.length && fitvids(".video-container"),
        c.length && (j(".docs-fixed").stickySidebar({
            topSpacing: 100,
            bottomSpacing: 100
        }),
        jQuery(function() {
            ...
            768 < jQuery(L).width() ? j(L).on("scroll", function() {
                ...
                a.each(function() {
                    ...
                    e <= i && i <= t && (n.find("a").removeClass("is-active"),
                    a.removeClass("is-active"),
                    j(this).addClass("is-active"),
                    n.find('a[href="#' + j(this).attr("id") + '"]').addClass("is-active"))
                })
        ...
        function k(e) {
            ...
            v.overhang(j.extend(C, {
                message: g.html(),
                callback: function(e) {
                    v.removeClass("overhang-push"),
        ...
        bulmaSteps.attach();
        n.length && (P.removeClass("is-active"),
        n.each(function() {
            var e = j(this);
    ...
    D(t).ready(function() {
        ...
        var f = "12659728099"
          ...
          , j = new Instafeed({
            ...
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && v < 20 && (v += 1,
                !0)
            },
            success: function(e) {
                v = 0
        ...
        var L = new Instafeed({
            ...
            template: '<figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && y < 6 && (y += 1,
                !0)
            },
            success: function(e) {
                y = 0
        ...
        var O = new Instafeed({
            ...
            template: '<figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && w < 6 && (w += 1,
                !0)
            },
            success: function(e) {
                w = 0
        ...
        var P = new Instafeed({
            ...
            template: '<figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && _ < 6 && (_ += 1,
                !0)
            },
            success: function(e) {
                _ = 0
        ...
        var R = new Instafeed({
            ...
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && b < 9 && (b += 1,
                !0)
            },
            success: function(e) {
                b = 0
        ...
        var I = new Instafeed({
            ...
            template: '<div class="column"><figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure></div>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && x < 8 && (x += 1,
                !0)
            },
            success: function(e) {
                x = 0
        ...
        var A = new Instafeed({
            ...
            template: '<div class="column"><figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure></div>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && T < 9 && (T += 1,
                !0)
            },
            success: function(e) {
                T = 0
        ...
        var Q = new Instafeed({
            ...
            template: '<div class="column"><figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure></div>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && C < 20 && (C += 1,
                !0)
            },
            success: function(e) {
                C = 0
        ...
        var z = new Instafeed({
            ...
            template: '<div class="column"><figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure></div>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && k < 18 && (k += 1,
                !0)
            },
            success: function(e) {
                k = 0
        ...
        var M = new Instafeed({
            ...
            template: '<div class="column"><figure class="instafeed-image"><a href="{{link}}" target="_blank"><img src="{{image}}" /><div class="instafeed-overlay"><div class="instafeed-info"><span><i class="icon-heart"></i> {{likes}}</span> <span><i class="icon-bubbles"></i> {{comments}}</span></div></div></a></figure></div>',
            filter: function(e) {
                return 0 <= e.tags.indexOf(m) && S < 20 && (S += 1,
                !0)
            },
            success: function(e) {
                S = 0
    ...
    w(e).ready(function() {
        ...
        if (t.length) {
            ...
            i.on("click", "li", function() {
                ...
                t.hasClass("hash-filter") && (location.hash = "filter=" + encodeURIComponent(e)),
                t.hasClass("isotope-pagination") && (r = e,
                f(),
                p(1),
                g(),
                m()),
        ...
        function m() {
            ...
            w(".pager").click(function() {
                ...
                w(".isotope-pager").find(".is-current").removeClass("is-current"),
                a == e && w(this).addClass("is-current")
            })
        }
        var v = !1;
        function y() {
            ...
            e && (i.find(".active").removeClass("active"),
            i.find('[data-filter="' + e + '"]').addClass("active")),
            AOS.init({
                disable: !0
            }))
        }
        t.hasClass("hash-filter") && (w(_).on("hashchange", y),
        y())
    })
}(jQuery, window, document),
function(a, e, n, t) {
...
function(s, t, e, i) {
    ...
    s(e).ready(function() {
        var r = s("header")
          , i = s("body")
          , a = (s("body.rtl"),
        r.find('.main-navigation ul li a[href*="#"]:not([href="#"])'))
          , e = i.find('a[href*="#"]:not([href="#"])');
        i.hasClass("header-one-page") && (a.on("click", function() {
            var e = r.height();
            if (i.hasClass("hide-on-scroll") && (e = 0),
        ...
        s(t).scroll(function() {
            ...
            0 === n && (a.parent("li").removeClass("active"),
            a.parent("li:first-child").addClass("active"))
        })),
        e.on("click", function() {
            var e = r.height();
            if (i.hasClass("hide-on-scroll") && (e = 0),
...
function(d, c, e, t) {
    ...
    d(e).ready(function() {
        ...
        c.pageYOffset)
          ...
          , o = i.height()
          , l = i.width();
        !a.hasClass("header-transparent") && !a.hasClass(" header-transparent-overlay") && a.hasClass("header-transparent-border"),
        d(c).scroll(function() {
            var e = d(c).scrollTop();
            if (a.hasClass("header-sticky") && !a.hasClass("header-side-navigation") && (a.hasClass("show-on-scroll") && (a.hasClass("boxed-layout") && i.css("width", l + "px"),
            0 !== e ? (a.hasClass("header-transparent") || a.hasClass(" header-transparent-overlay") || a.hasClass("header-transparent-border"),
            e > i.height() ? (i.css("position", "fixed").css("top", 0),
            59 < i.height() && i.addClass("show-on-scroll")) : a.hasClass("header-center-overlay") ? i.css("position", "").css("top", -(i.height() + r)) : i.css("position", "").css("top", "-100%"),
            s.css("top", -o)) : (a.hasClass("header-transparent") || a.hasClass(" header-transparent-overlay") || a.hasClass("header-transparent-border"),
            i.removeClass("show-on-scroll"),
            (a.hasClass("header-center-overlay") || a.hasClass("header-transparent") || a.hasClass("header-transparent-overlay")) && i.css("top", 0),
            s.css("top", 0))),
            a.hasClass("hide-on-scroll"))) {
                a.hasClass("boxed-layout") && i.css("width", l + "px");
                var t = c.pageYOffset;
                0 !== t ? (a.hasClass("header-transparent") || a.hasClass(" header-transparent-overlay") || a.hasClass("header-transparent-border"),
                t < n ? (a.hasClass("header-topbar"),
                i.css("position", "fixed").css("top", 0),
                59 < i.height() && i.addClass("hide-on-scroll"),
                (a.hasClass("header-menu-background-primary") || a.hasClass("header-menu-background-dark")) && i.addClass("hide-on-scroll")) : a.hasClass("header-center-overlay") ? i.css("position", "fixed").css("top", -(i.height() + r)) : i.css("position", "fixed").css("top", -i.height()),
                n = t,
                s.css("top", -o)) : (a.hasClass("header-transparent") || a.hasClass(" header-transparent-overlay") || a.hasClass("header-transparent-border"),
                i.css("position", ""),
...
function(j, L, O, e) {
    ...
    j(O).ready(function() {
        ...
        function T() {
            ...
            u && (y.find(".level.top .level-right").length ? n.hasClass("header-logo-with-icons") && y.find(".level.top .level-right").length < 2 && y.find(".level.top").append('<div class="level-right" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>') : y.find(".level.top").append('<div class="level-right" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>')),
            h && (y.find(".level").last().find(".level-right.num-2").length || y.find(".level").last().append('<div class="level-right num-2" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>'),
            y.find(".level.top").find(".level-right").length || y.find(".level.top").append('<div class="level-right num-2" style="display: none;"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div>')),
            (g || m) && (y.find(".level.top").length || (n.hasClass("icon-left") ? y.prepend('<div class="level top" style="display: none;"><div class="level-left"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div><div class="level-right"><div id="header-logo" class="site-logo">' + t + "</div></div></div>") : y.prepend('<div class="level top" style="display: none;"><div class="level-left"><div id="header-logo" class="site-logo">' + t + '</div></div><div class="level-right"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div></div>'))),
            p && !f && (y.find(".level.top").length || (n.hasClass("side-right") ? y.prepend('<div class="level top" style="display: none;"><div class="level-left"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div><div class="level-right"><div id="header-logo" class="site-logo">' + t + "</div></div></div>") : y.prepend('<div class="level top" style="display: none;"><div class="level-left"><div id="header-logo" class="site-logo">' + t + '</div></div><div class="level-right"><div class="hamburger-menu"><span class="hamburger-menu-icon"></span></div></div></div>'))),
            e < 1088) {
                if (n.hasClass("footer-widgets") && n.find("#footer-wrap .site-footer-inner .columns .column").each(function() {
                    ...
                    j(this).hasClass("is-4") && (j(this).removeClass("is-4"),
                    j(this).addClass("is-4-desktop")),
                    j(this).hasClass("is-3") && (j(this).removeClass("is-3"),
                    j(this).addClass("is-3-desktop"))
                }),
                ...
                c || p)
                    ...
                    if (n.hasClass("header-logo-right") ? n.addClass("header-hamburger-menu slide-left slide-overlay") : n.addClass("header-hamburger-menu slide-right slide-overlay"),
                    y.addClass("header-fullwidth"),
                    y.find(".level.top").length)
                        if (u)
                            y.find(".level.top").css("display", "flex"),
                            y.find(".level.top .level-right").show(),
                            n.hasClass("header-logo-with-icons") && y.find(".level.top .level-left").first().hide();
                        else if (h) {
                    ...
                    l = j(".header-hamburger-menu"),
                    d = j(".header-hamburger-menu header .level:last-child"),
                    n.hasClass("header-logo-right") ? d.find(".level-right").last().hide() : n.hasClass("header-logo-center-menu-center") ? d.find(".site-logo").hide() : u ? n.hasClass("header-logo-with-icons") ? d.find(".level-left").first().show() : 1 < d.find(".level-left").length ? d.find(".level-left").first().hide() : d.find(".level-left").first().show() : h ? y.find(".level").last().find(".level-left").show() : d.find(".level-left").last().hide()
                }
                (g || m) && (n.removeClass("slide-up"),
                ...
                l = j(".header-hamburger-menu"),
                d = j(".header-hamburger-menu header .level:last-child")),
                p && !f && (n.removeClass("header-side-navigation"),
                ...
                if (n.hasClass("footer-widgets") && n.find("#footer-wrap .site-footer-inner .columns .column").each(function() {
                    ...
                    j(this).hasClass("is-4-desktop") && (j(this).removeClass("is-4-desktop"),
                    j(this).addClass("is-4")),
                    j(this).hasClass("is-3-desktop") && (j(this).removeClass("is-3-desktop"),
                    j(this).addClass("is-3"))
                }),
                n.removeClass("responsive-layout"),
                f || v.removeClass("responsive-on-scroll"),
                "0px" === d.css("margin-right") && "0px" === d.css("margin-left") && (l.hasClass("slide-right") || l.hasClass("slide-left")) && (d.toggleClass("opened"),
                o.toggleClass("expanded"),
                l.toggleClass("pushed")),
                !c && !p) {
                    if (n.hasClass("header-logo-right") ? d.find(".level-right").last().show() : n.hasClass("header-logo-center-menu-center") ? d.find(".site-logo").show() : u ? d.find(".level-left").first().css("display", "flex") : h ? 2 === y.find(".level").first().find(".level-left").length && y.find(".level").first().find(".level-left").first().css("display", "flex") : d.find(".level-left").last().show(),
                    ...
                    y.find(".level.top").length && (u || y.find(".level.top").hide(),
                    u && (n.hasClass("header-logo-with-icons") ? (y.find(".level.top .level-right").last().hide(),
                    y.find(".level.top .level-left").first().css("display", "flex")) : y.find(".level.top .level-right").hide()),
                    h)) {
                    ...
                    (n.hasClass("header-logo-center") || u) && y.find(".logo-text").show(),
                    o = j(".hamburger-menu"),
                    l = j(".header-hamburger-menu"),
                    d = j(".header-hamburger-menu header .level:last-child")
                }
                (g || m) && (g && n.addClass("slide-up"),
                ...
                l = j(".header-hamburger-menu"),
                d = j(".header-hamburger-menu header .level:last-child")),
                p && !f && (n.addClass("header-side-navigation"),
        ...
        if ((j("body").hasClass("rtl") || j("html").hasClass("rtl") || "rtl" == b) && (x = !0),
        T(),
        j(L).resize(T),
        i.length) {
            ...
            i.find("> ul > li").each(function() {
                if (!j(this).hasClass("mega-menu") || j("body").hasClass("overlay-full-width") || j("body").hasClass("slide-overlay") || j("body").hasClass("header-side-navigation") || j("body").hasClass("header-background-primary") || j("body").hasClass("header-background-dark") || j("body").hasClass("slide-push"))
                    j(this).hasClass("mega-menu") && j(this).removeClass("mega-menu"),
                    j(this).find("> ul li:has( > ul)").addClass("menu-right-icon");
                else {
                    var e = j(this);
                    j("body").hasClass("header-side-navigation") ? j(this).hasClass("niche-templates") ? j(this).find("> ul").addClass("container columns is-3 is-variable is-multiline").css("margin-top", 0) : j(this).find("> ul").addClass("container columns is-gapless").css("margin-top", 0) : j(this).hasClass("niche-templates") ? j(this).find("> ul").addClass("container columns is-3 is-variable is-multiline").css("margin-left", -(j(this).offset().left - C)).css("margin-top", 0) : j(this).find("> ul").addClass("container columns is-gapless").css("margin-left", -(j(this).offset().left - C)).css("margin-top", 0),
                    j(this).find("> ul > li").each(function() {
                        j(this).addClass("column"),
                        e.hasClass("niche-templates") && j(this).addClass("is-3")
                    })
                }
            }),
            k()
        ...
        function k() {
            ...
            if (e < 1088)
                ...
                i.find("ul li > span").unbind().click(function() {
                    j(this).hasClass("main-parent") && (i.find("ul li ul").fadeOut("fast"),
                    i.find("ul li > span").removeClass("opened")),
                    j(this).closest("li").children("ul").is(":visible") ? (j(this).removeClass("opened"),
                    j(this).closest("li").children("ul").fadeOut("fast")) : (j(this).addClass("opened"),
                    j(this).closest("li").children("ul").slideToggle(400))
                }),
                j(O).on("click", function(e) {
                    j(e.target).closest(".main-navigation").length || i.find("ul li ul").is(":visible") && (i.find("ul li ul").fadeOut("fast"),
                    i.find("ul li > span").removeClass("opened"))
                });
            else {
                if (e < 1280)
                    i.find("> ul > li").each(function() {
                        j(this).hasClass("mega-menu") && (j(this).addClass("old-mega-menu"),
                        ...
                        j(this).find("> ul li").hover(function() {
                            if (j(this).children("ul").hide(),
                            j(this).children("ul").fadeIn(350),
                            j(this).children("ul").length) {
                                var e = j(this).children("ul");
                                e.offset().left + e.width() <= n.width() + n.offset().left || (j(this).children("ul").removeClass("open-left"),
                                j(this).children("ul").addClass("open-left"))
                            }
                        }, function() {
                    ...
                    i.find("> ul > li").each(function() {
                        j(this).hasClass("old-mega-menu") && (j(this).addClass("mega-menu"),
                        j(this).removeClass("old-mega-menu"),
                        j(this).find("> ul").addClass("container columns").css("margin-left", -(j(this).offset().left - t)).css("margin-top", 0),
                ...
                i.find("ul li").hover(function() {
                    if (j(this).hasClass("mega-menu"))
                        j(this).find("> ul").fadeIn(350);
                    else if (j(this).hasClass("column"))
                        j(this).find("> ul").show();
                    else if (j(this).children("ul").hide(),
                    j(this).children("ul").fadeIn(350),
                    j(this).children("ul").length) {
                        var e = j(this).children("ul");
                        e.offset().left + e.width() <= n.width() + n.offset().left || (j(this).children("ul").removeClass("open-left"),
        ...
        j(L).resize(k),
        e.length && (e.hasClass("on-click") ? (j(O).on("click", function(e) {
        ...
        a.length && a.find("ul").length && (j(O).on("click", function(e) {
            ...
            j(e.target).closest(".search-form-overlay input").length || j(".search-form-overlay input").is(":focus") || (r.hide(),
            r.removeClass("is-active"),
            r.fadeOut("fast"))
        }),
        a.find("> li").on("click", function(e) {
            var t = j(e.target).parent().attr("class");
            if (j(this).hasClass("search-style-2") && (a.find("ul").hide(),
            a.find("ul").fadeOut("fast"),
            r.fadeIn(350),
            ...
            "product-remove" !== t && !j(".dropdown-search-form input").is(":focus") && !j(this).hasClass("search-style-2") && !j(this).find(".dropdown-user-account").is(":visible"))
                if (j(this).children("ul").is(":visible"))
                    a.find("ul").hide(),
                    a.find("ul").fadeOut("fast");
                else if (a.find("ul").hide(),
                j(this).children("ul").fadeIn(350),
                j(this).children("ul").length) {
                    var i = j(this).children("ul");
                    i.offset().left + i.width() <= n.width() + n.offset().left || (j(this).children("ul").removeClass("open-left"),
                    j(this).children("ul").addClass("open-left"))
                }
        }));
        var S = j("header").width() + 1;
        j("body").hasClass("header-side-navigation") && j("body").hasClass("side-left") && (j(".site-header-top").css("margin-left", S),
        ...
        j("body").hasClass("header-side-navigation") && j("body").hasClass("side-right") && (j(".site-header-top").css("margin-right", S),
        ...
        j(".rev_slider_wrapper").css("max-width", j("body").width() - S + "px")),
        s.length && (j(O).on("click", function(e) {
            t.find(".site-header .level").each(function() {
                j(this).hasClass("top") || j(e.target).closest(".header-side-navigation .site-header .level").length || j(this).is(":visible") && (s.find("i").attr("class", "ion-ios-menu"),
                j(this).fadeOut("fast"))
            })
        }),
        s.on("click", function(e) {
            j("body").hasClass("header-side-navigation") && j("body").hasClass("side-mini") && (s.find("i").attr("class", "ion-ios-close-outline"),
            t.find(".site-header .level").each(function() {
                j(this).hasClass("top") || (j(this).is(":visible") ? (s.find("i").attr("class", "ion-ios-menu"),
                j(this).hide(),
                j(this).fadeOut("fast")) : (j(this).hide(),
                j(this).fadeIn(350)))
            }))
        })),
        o.length && (j(O).on("click", function(e) {
            j(e.target).closest("header .level:last-child").length || j(e.target).closest(".hamburger-menu").length || "0px" === d.css("margin-right") && "0px" === d.css("margin-left") && (l.hasClass("slide-right") || l.hasClass("slide-left")) && (d.toggleClass("opened"),
            o.toggleClass("expanded"),
            l.toggleClass("pushed"))
        }),
        o.on("click", function(e) {
            ...
            (l.hasClass("slide-down") || l.hasClass("slide-up")) && (l.hasClass("icon-left") ? y.hasClass("header-fullwidth") ? x ? i.css("right", j(this).width() + 45) : i.css("left", j(this).width() + 45) : x ? i.css("right", j(this).width() + 15) : i.css("left", j(this).width() + 15) : y.hasClass("header-fullwidth") ? x ? i.css("left", j(this).width() + 45) : i.css("right", j(this).width() + 45) : x ? i.css("left", j(this).width() + 15) : i.css("right", j(this).width() + 15),
            i.slideToggle(),
            C = j(".container").offset().left,
            i.find("> ul > li").each(function() {
                j(this).hasClass("mega-menu") ? (j(this).find("> ul").addClass("container columns is-gapless").css("margin-left", -(j(this).offset().left - C)).css("margin-top", 0),
                j(this).find("> ul > li").each(function() {
                    j(this).addClass("column")
                })) : j(this).find("> ul li:has( > ul)").addClass("menu-right-icon")
            })),
            (l.hasClass("slide-right") || l.hasClass("slide-left")) && (l.hasClass("slide-overlay") && d.toggleClass("opened"),
            l.hasClass("slide-push") && (d.toggleClass("opened"),
            l.toggleClass("pushed")),
            l.hasClass("overlay-full-width") && i.find("> ul > li").each(function() {
                j(this).hasClass("mega-menu") && j(this).removeClass("mega-menu")
            }))
        }))
    })
...
function(r, s, e, t) {
    ...
    r(e).ready(function() {
        ...
        e.length && e.each(function() {
            ...
            (a = r(this).hasClass("circle") ? (e = r.extend(e, {
                text: {
            ...
            r(s).scroll(function(e) {
                var t, i;
                t = n,
                i = r(s).scrollTop() + r(s).height(),
                t.offset().top + 100 <= i ? a.animate(n.attr("data-value")) : a.set(0)
            })
        })
    })
}(jQuery, window, document),
function(i, e, t, a) {
    ...
    i(t).ready(function() {
        ...
        i("#barrating-square").barrating("show", {
            theme: "bars-square",
            showValues: !0,
        ...
        i(".stars-fontawesome-o .clear-rating").on("click", function(e) {
            e.preventDefault(),
            i("#barrating-fontawesome-o").barrating("clear")
        }),
        i("#barrating-fontawesome-o").barrating({
            ...
            initialRating: e,
            onSelect: function(e, t) {
                e ? (i(".stars-fontawesome-o .current-rating").addClass("hidden"),
                i(".stars-fontawesome-o .your-rating").removeClass("hidden").find("span").html(e)) : i("#barrating-fontawesome-o").barrating("clear")
            },
...
function(n, r, e, t) {
    ...
    n(e).ready(function() {
        ...
        e.find("#rev_slider_1"))
          , i = "auto";
        if (e.hasClass("boxed-layout") && (i = "auto"),
        t.length) {
            var a = t.show().revolution({
    ...
    s(t).ready(function() {
        ...
        var r = {
            ...
            switchTab: function(e) {
                ...
                e.hasClass("is-active") || (e.siblings().removeClass("is-active"),
                e.addClass("is-active"),
                r.showPane(e.index(), t))
            },
            showPane: function(e, t) {
                var i = t.find(".tab-block");
                i.slideUp(r.s.animLen),
                s(i[e]).slideDown(r.s.animLen)
            }
        };
...
function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        revolution: function(t) {
            ...
            this.each(function() {
                ...
                "hero" == t.sliderType && e.find(">ul>li").each(function(e) {
                ...
                jQuery(this).on("scriptsloaded", function() {
                    if (t.modulesfailing)
                        return e.html('<div style="margin:auto;line-height:40px;font-size:14px;color:#fff;padding:15px;background:#e74c3c;margin:20px 0px;">!! Error at loading Slider Revolution 5.0 Extrensions.' + t.errorm + "</div>").show(),
                        !1;
                    _R.migration != undefined && (t = _R.migration(e, t)),
                    punchgs.force3D = !0,
                    "on" !== t.simplifyAll && punchgs.TweenLite.lagSmoothing(1e3, 16),
                    prepareOptions(e, t),
                    initSlider(e, t)
                }),
                e[0].opt = t,
    ...
    jQuery.extend(!0, _R, {
        ...
        compare_version: function(e) {
            var t = jQuery("body").data("tp_rs_version");
            return (t = t === undefined ? new Object : t).Core === undefined && (t.Core = new Object,
            t.Core.alias = "Slider Revolution Core",
            t.Core.name = "jquery.themepunch.revolution.min.js",
            t.Core.ver = _R.getversion().core),
            ...
            console.log("%c     It might be required to purge and clear Server/Client side Caches.", "color:#333")),
            e.check = "stop")),
            t[e.alias] === undefined && (t[e.alias] = new Object,
            t[e.alias].alias = e.alias,
            t[e.alias].ver = e.version,
            t[e.alias].name = e.name),
        ...
        is_mobile: function() {
            var e = ["android", "webos", "iphone", "ipad", "blackberry", "Android", "webos", , "iPod", "iPhone", "iPad", "Blackberry", "BlackBerry"]
              , t = !1;
            for (var i in e)
                1 < navigator.userAgent.split(e[i]).length && (t = !0);
            return t
        },
        is_android: function() {
        ...
        get_browser: function() {
            ...
            (a = a ? [a[1], a[2]] : [t, navigator.appVersion, "-?"])[0]
        },
        ...
        callingNewSlide: function(e, t) {
            ...
            t && jQuery.isNumeric(t) || t.match(/to/g) ? (a = 1 === t || -1 === t ? (a = i + t) < 0 ? n.slideamount - 1 : a >= n.slideamount ? 0 : a : (t = jQuery.isNumeric(t) ? t : parseInt(t.split("to")[1], 0)) < 0 ? 0 : t > n.slideamount - 1 ? n.slideamount - 1 : t,
            e.find(".tp-revslider-slidesli:eq(" + a + ")").addClass("next-revslide")) : t && e.find(".tp-revslider-slidesli").each(function() {
                var e = jQuery(this);
        ...
        setSize: function(e) {
            ...
            e.rowzones && 0 < e.rowzones.length)
                for (var o = 0; o < e.rowzones[s].length; o++)
                    r += e.rowzones[s][o][0].offsetHeight;
        ...
        enterInViewPort: function(i) {
            i.waitForCountDown && (countDown(i.c, i),
            i.waitForCountDown = !1),
            i.waitForFirstSlide && (swapSlide(i.c),
            ...
            i.lastplayedvideos != undefined && 0 < i.lastplayedvideos.length && jQuery.each(i.lastplayedvideos, function(e, t) {
                _R.playVideo(t, i)
            })
        },
        leaveViewPort: function(i) {
            ...
            i.playingvideos != undefined && 0 < i.playingvideos.length && (i.lastplayedvideos = jQuery.extend(!0, [], i.playingvideos),
            i.playingvideos && jQuery.each(i.playingvideos, function(e, t) {
                i.leaveViewPortBasedStop = !0,
    ...
    var _ISM = _R.is_mobile()
      ...
      , checkIDS = function(e, t) {
        ...
        -1 != jQuery.inArray(t.attr("id"), e.anyid)) {
      ...
      , lAjax = function(t, i) {
        return !jQuery("body").data(t) && (i.filesystem ? (i.errorm === undefined && (i.errorm = "<br>Local Filesystem Detected !<br>Put this to your header:"),
        ...
        console.log(" "),
        !(i.modulesfailing = !0)) : (jQuery.ajax({
            url: i.jsFileLocation + t + i.extensions_suffix + "?version=" + version.core,
            dataType: "script",
            cache: !0,
            error: function(e) {
                console.warn("Slider Revolution 5.0 Error !"),
                console.error("Failure at Loading:" + t + i.extensions_suffix + " on Path:" + i.jsFileLocation),
                console.info(e)
            }
        }),
      ...
      , getNeededScripts = function(i, e) {
        ...
        ("carousel" == i.sliderType || "on" == a.keyboardNavigation || "on" == a.mouseScrollNavigation || "on" == a.touch.touchenabled || a.arrows.enable || a.bullets.enable || a.thumbnails.enable || a.tabs.enable) && (t.navigation = !0),
        ...
        !t.videos && (0 < e.find(".rs-background-video-layer").length || 0 < e.find(".tp-videolayer").length || 0 < e.find(".tp-audiolayer").length || 0 < e.find("iframe").length || 0 < e.find("video").length) && (t.videos = !0),
        "carousel" == i.sliderType && (t.carousel = !0),
        ("off" !== i.parallax.type || i.viewPort.enable || "true" == i.viewPort.enable || "true" === i.scrolleffect.on || i.scrolleffect.on) && (t.parallax = !0)) : (t.kenburns = !0,
        t.parallax = !0,
        t.carousel = !1,
        t.navigation = !0,
        t.videos = !0,
        ...
        t.layeranim = !0,
        t.migration = !0),
        "hero" == i.sliderType && (t.carousel = !1,
        t.navigation = !1),
        ...
        i.addons != undefined && 0 < i.addons.length && jQuery.each(i.addons, function(e, t) {
      ...
      , initSlider = function(container, opt) {
        ...
        opt.ul.find(">li").each(function(e) {
            ...
            (t.data("invisible") || !0 === t.data("invisible")) && (t.addClass("tp-invisible-slide"),
            t.appendTo(opt.ul))
        }),
      ...
      , runSlider = function(i, x) {
        ...
        "on" == x.shuffle) {
            ...
            e.fstransition = t.data("fstransition"),
            e.fsmasterspeed = t.data("fsmasterspeed"),
            e.fsslotamount = t.data("fsslotamount");
        ...
        jQuery.each(x.allli, function(e, t) {
            ...
            a = 1; a <= 10; a++)
                t.data("param" + a) !== undefined && n.params.push({
        ...
        "on" == x.simplifyAll && (_R.isIE(8) || _R.iOSVersion()) && (i.find(".tp-caption").each(function() {
            var e = jQuery(this);
        ...
        "fullwidth" == x.sliderLayout && "off" == x.autoHeight && i.css({
        ...
        if (x.shadow !== undefined && 0 < x.shadow && (i.parent().addClass("tp-shadow" + x.shadow),
        i.parent().append('<div class="tp-shadowcover"></div>'),
        i.parent().find(".tp-shadowcover").css({
        ...
        !i.hasClass("revslider-initialised")) {
            ...
            var c = jQuery.fn.jquery.split(".")
              ...
              , h = parseFloat(c[1]);
            parseFloat(c[2] || "0"),
            1 == u && h < 7 && i.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:' + c + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>"),
            1 < u && (x.ie = !1);
            var T = new Object;
            T.addedyt = 0,
            T.addedvim = 0,
            ...
            i.find(".tp-caption, .rs-background-video-layer").each(function(e) {
                var n = jQuery(this)
                  ...
                  , a = t.autoplay
                  , r = (t.videomp4 !== undefined || t.videowebm !== undefined || t.videoogv,
                ...
                n.hasClass("tp-caption")) {
                    var u = n.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : ""
                      ...
                      , m = "";
                    "row" === f ? (n.addClass("rev_row").removeClass("tp-resizeme"),
                    m = "rev_row_wrap") : "column" === f ? (p = h.verticalalign === undefined ? " vertical-align:bottom;" : " vertical-align:" + h.verticalalign + ";",
                    m = "rev_column",
                    ...
                    var v = ""
                      , y = "";
                    "row" !== f && "group" !== f && "column" !== f ? (v = "display:" + n.css("display") + ";",
                    0 < n.closest(".rev_column").length ? (n.addClass("rev_layer_in_column"),
                    o = !1) : 0 < n.closest(".rev_group").length && (n.addClass("rev_layer_in_group"),
                    o = !1)) : "column" === f && (o = !1),
                    ...
                    n.wrap("<div " + y + ' class="tp-parallax-wrap ' + m + '" style="' + p + " " + u + "position:" + g + ";" + v + ";visibility:hidden" + w + '"><div class="tp-loop-wrap" style="' + u + "position:" + g + ";" + v + ';"><div class="tp-mask-wrap" style="' + u + "position:" + g + ";" + v + ';" ></div></div></div>'),
                    ...
                    "column" === f && (n.append('<div class="rev_column_bg rev_column_bg_man_sized" style="visibility:hidden"></div>'),
            ...
            x.allli.each(function(e) {
                ...
                "all" != x.lazyType && ("smart" != x.lazyType || 0 != e && 1 != e && e != x.slideamount && e != x.slideamount - 1) || (loadImages(t, x, e),
                waitForCurrentImages(t, x, function() {}))
            });
            var p = getUrlVars("#")[0];
            if (p.length < 9 && 1 < p.split("slide").length) {
                var f = parseInt(p.split("slide")[1], 0);
                f < 1 && (f = 1),
                f > x.slideamount && (f = x.slideamount),
                x.startWithSlide = f - 1
            }
            ...
            _R.scrollTicker && _R.scrollTicker(x, i)),
            ...
            jQuery(window).on(m, function() {
                ...
                if ("fullscreen" == x.sliderLayout) {
                    ...
                    e = "mobile" == x.fallbacks.ignoreHeightChanges && _ISM || "always" == x.fallbacks.ignoreHeightChanges ? (x.fallbacks.ignoreHeightChangesSize = x.fallbacks.ignoreHeightChangesSize == undefined ? 0 : x.fallbacks.ignoreHeightChangesSize,
                    t != x.lastwindowheight && Math.abs(t - x.lastwindowheight) > x.fallbacks.ignoreHeightChangesSize) : t != x.lastwindowheight
                }
                (i.outerWidth(!0) != x.width || i.is(":hidden") || e) && (x.lastwindowheight = jQuery(window).height(),
                containerResized(i, x))
            }),
            hideSliderUnder(i, x),
            contWidthManager(x),
            x.fallbacks.disableFocusListener || "true" == x.fallbacks.disableFocusListener || !0 === x.fallbacks.disableFocusListener || (i.addClass("rev_redraw_on_blurfocus"),
            tabBlurringCheck())
        }
    }
      , cArray = function(e, t) {
      ...
      , checkHoverDependencies = function(e, n) {
        ...
        ("sliderenter" === t.start || t.frames !== undefined && t.frames[0] != undefined && "sliderenter" === t.frames[0].delay) && (n.layersonhover === undefined && (n.c.on("tp-mouseenter", function() {
            n.layersonhover && jQuery.each(n.layersonhover, function(e, t) {
                ...
                t.data("closestli") === undefined && (t.data("closestli", i),
                t.data("staticli", a)),
                (0 < i.length && i.hasClass("active-revslide") || i.hasClass("processing-revslide") || 0 < a.length) && (t.data("animdirection", "in"),
      ...
      , containerResized = function(e, t) {
        ...
        setCurWinRange(t),
        setCurWinRange(t, !0),
        !_R.resizeThumbsTabs || !0 === _R.resizeThumbsTabs(t)) {
            ...
            removeSlots(e, t, e, 2),
            "standard" === t.sliderType && (punchgs.TweenLite.set(a.find(".defaultimg"), {
                opacity: 0
            }),
            ...
            t.pcartimer = setTimeout(function() {
                ...
                "carousel" == t.sliderType && "on" === t.carousel.showLayersAllTime && jQuery.each(t.li, function(e) {
                    _R.animateTheCaptions({
                        slide: jQuery(t.li[e]),
                        opt: t,
                        recall: !0
      ...
      , prepareSlides = function(e, u) {
        ...
        u.allli.each(function(e) {
            ...
            (u.startWithSlide != undefined && i == u.startWithSlide || u.startWithSlide === undefined && 0 == e) && t.addClass("next-revslide"),
            t.css({
                width: "100%",
                height: "100%",
                overflow: "hidden"
        ...
        u.allli.find(">img").each(function(e) {
            ...
            "on" == u.fallbacks.panZoomDisableOnMobile && _ISM && (t.data("kenburns", "off"),
            t.data("bgfit", "cover"));
            ...
            o = l !== undefined && 0 <= l.indexOf("gradient") ? '"background:' + l + ';width:100%;height:100%;"' : '"background-color:' + l + ";background-repeat:" + r.bgrepeat + ";background-image:url(" + s + ");background-size:" + r.bgfit + ";background-position:" + r.bgposition + ';width:100%;height:100%;"',
      ...
      , cutParams = function(e) {
        var t = e;
        return e != undefined && 0 < e.length && (t = e.split("?")[0]),
        t
    }
      ...
      , imgLoaded = function(l, e, d) {
        e.syncload--,
        e.loadqueue && jQuery.each(e.loadqueue, function(e, t) {
      ...
      , waitForCurrentImages = function(s, o, e) {
        ...
        s.find("img,.defaultimg, .tp-svg-layer").each(function() {
            ...
            if (e.data("loaded") === undefined && i !== undefined && i.progress && i.progress.match(/loaded/g)) {
                ...
                "img" == i.type)
                    if (e.hasClass("defaultimg"))
                        _R.isIE(8) ? defimg.attr("src", i.src) : -1 == i.src.indexOf("images/transparent.png") && -1 == i.src.indexOf("assets/transparent.png") || e.data("bgcolor") === undefined ? e.css({
                    ...
                    "svg" == i.type && "loaded" == i.progress && (e.append('<div class="tp-svg-innercontainer"></div>'),
                    e.find(".tp-svg-innercontainer").append(i.innerHTML));
                e.data("loaded", !0)
            }
            if (i && i.progress && i.progress.match(/inprogress|inload|prepared/g) && (!i.error && jQuery.now() - e.data("start-to-load") < 5e3 ? l = !0 : (i.progress = "failed",
            i.reported_img || (i.reported_img = !0,
            console.warn(t + "  Could not be loaded !")))),
            1 == o.youtubeapineeded && (!window.YT || YT.Player == undefined) && (l = !0,
            5e3 < jQuery.now() - o.youtubestarttime && 1 != o.youtubewarning)) {
                o.youtubewarning = !0;
            ...
            1 == o.vimeoapineeded && !window.Vimeo && (l = !0,
            5e3 < jQuery.now() - o.vimeostarttime && 1 != o.vimeowarning) && (o.vimeowarning = !0,
        ...
        jQuery.each(o.loadqueue, function(e, t) {
            !0 !== t.static || "loaded" == t.progress && "failed" !== t.progress || ("failed" == t.progress ? t.reported || (t.reported = !0,
            console.warn("Static Image " + t.src + "  Could not be loaded in time. Error Exists:" + t.error)) : !t.error && jQuery.now() - t.starttoload < 5e3 ? l = !0 : t.reported || (t.reported = !0,
      ...
      , swapSlide = function(e) {
        ...
        t.carousel.fadein = !0),
        a.index() === i.index() && !0 !== t.onlyPreparedSlide)
            return a.removeClass("next-revslide"),
            !1;
        !0 === t.onlyPreparedSlide && (t.onlyPreparedSlide = !1,
        jQuery(t.li[0]).addClass("processing-revslide")),
        ...
        "on" == t.stopLoop && a.index() == t.lastslidetoshow - 1 && (e.find(".tp-bannertimer").css({
            visibility: "hidden"
        }),
        e.trigger("revolution.slide.onstop"),
        t.noloopanymore = 1),
        a.index() === t.slideamount - 1 && (t.looptogo = t.looptogo - 1,
        t.looptogo <= 0 && (t.stopLoop = "on")),
        t.tonpause = !0,
        e.trigger("stoptimer"),
        t.cd = 0,
        "off" === t.spinner && (t.loader !== undefined ? t.loader.css({
            display: "none"
      ...
      , swapSlideProgress = function(e, t) {
        ...
        s.tonpause = !1,
        s.cd = 0,
        clearTimeout(s.loadertimer),
        s.loader !== undefined && s.loader.css({
            display: "none"
        }),
        _R.setSize(s),
        _R.slotSize(e, s),
        _R.manageNavigation && _R.manageNavigation(s);
        var o = {};
        o.nextslide = a,
        o.currentslide = i,
        ...
        s.transition = 1,
        s.videoplaying = !1,
        a.data("delay") != undefined ? (s.cd = 0,
        s.delay = a.data("delay")) : s.delay = s.origcd,
        "true" == a.data("ssop") || !0 === a.data("ssop") ? s.ssop = !0 : s.ssop = !1,
        t.trigger("nulltimer");
        var l, d = i.index(), c = a.index();
        if (s.sdir = c < d ? 1 : 0,
        "arrow" == s.sc_indicator && (0 == d && c == s.slideamount - 1 && (s.sdir = 1),
        d == s.slideamount - 1 && 0 == c && (s.sdir = 0)),
        ...
        "carousel" == s.sliderType)
            ...
            "on" == a.data("randomtransition") ? h = Math.round(Math.random() * u.length) : h += 1,
            h == u.length && (h = 0),
            a.data("nexttransid", h);
            var p = u[h];
            s.ie && ("boxfade" == p && (p = "boxslide"),
            "slotfade-vertical" == p && (p = "slotzoom-vertical"),
            "slotfade-horizontal" == p && (p = "slotzoom-horizontal")),
            _R.isIE(8) && (p = 11),
            l = _R.animateSlide(0, p, t, a, i, r, n, l),
            "on" == r.data("kenburns") && (_R.startKenBurn(r, s),
            l.add(punchgs.TweenLite.set(r, {
                autoAlpha: 0
            }))),
            l.pause()
        }
        _R.scrollHandling && (_R.scrollHandling(s, !0, 0),
        l.eventCallback("onUpdate", function() {
            _R.scrollHandling(s, !0, 0)
        })),
        "off" != s.parallax.type && s.parallax.firstgo == undefined && _R.scrollHandling && (s.parallax.firstgo = !0,
        s.lastscrolltop = -999,
        _R.scrollHandling(s, !0, 0),
        setTimeout(function() {
            s.lastscrolltop = -999,
        ...
        _R.animateTheCaptions ? "carousel" === s.sliderType && "on" === s.carousel.showLayersAllTime ? (jQuery.each(s.li, function(e) {
      ...
      , letItFree = function(e, t, i, a, n, r) {
        var s = e[0].opt;
        "carousel" === s.sliderType || (s.removePrepare = 0,
        punchgs.TweenLite.to(t.find(".defaultimg"), .001, {
            zIndex: 20,
            autoAlpha: 1,
            onComplete: function() {
                removeSlots(e, s, a, 1)
        ...
        "scroll" != s.parallax.type && "scroll+mouse" != s.parallax.type && "mouse+scroll" != s.parallax.type || (s.lastscrolltop = -999,
        _R.scrollHandling(s)),
        r.clear(),
        i.data("kbtl") != undefined && (i.data("kbtl").reverse(),
        i.data("kbtl").timeScale(25)),
        "on" == t.data("kenburns") && (t.data("kbtl") != undefined ? (t.data("kbtl").timeScale(1),
        t.data("kbtl").play()) : _R.startKenBurn(t, s)),
        a.find(".rs-background-video-layer").each(function(e) {
            if (_ISM && !s.fallbacks.allowHTML5AutoPlayOnAndroid)
                return !1;
            var t = jQuery(this);
        ...
        n.find(".rs-background-video-layer").each(function(e) {
            if (_ISM)
                return !1;
            var t = jQuery(this);
            _R.stopVideo && (_R.resetVideo(t, s),
            _R.stopVideo(t, s)),
        ...
        s.startWithSlide !== undefined && "done" !== s.startWithSlide && "carousel" === s.sliderType) {
            for (var l = s.startWithSlide, d = 0; d <= s.li.length - 1; d++)
                jQuery(s.li[d]).data("originalindex") === s.startWithSlide && (l = d);
            0 !== l && _R.callingNewSlide(s.c, l),
            s.startWithSlide = "done"
        }
      ...
      , countDown = function(e, t) {
        ...
        e.on("restarttimer", function() {
            if (!t.forcepause_viatoggle) {
                ...
                e[0].tween.kill(),
                e[0].tween = punchgs.TweenLite.fromTo(e, t.delay / 1e3, {
                    width: "0%"
                }, {
                    force3D: "auto",
                    width: "100%",
        ...
        1 < t.slideamount && (0 != t.stopAfterLoops || 1 != t.stopAtSlide) ? e.trigger("starttimer") : (t.noloopanymore = 1,
        e.trigger("nulltimer")),
    ...
    function a(e, y) {
        ...
        function p(e) {
            if (!0 !== o.data(Ie + "_intouch") && !(0 < oe(e.target).closest(y.excludedElements, o).length)) {
                var t, i, a = e.originalEvent ? e.originalEvent : e, n = a.touches, r = n ? n[0] : a;
                return L = ke,
                ...
                j = i,
                J(),
                !n || O === y.fingers || y.fingers === Te || H() ? (ee(0, r),
                l = se(),
                2 == O && (ee(1, n[1]),
                x = T = re(P[0].start, P[1].start)),
                (y.swipeStatus || y.pinchStatus) && (t = z(a, L))) : t = !1,
                !1 === t ? (z(a, L = Le),
                t) : (y.hold && (I = setTimeout(oe.proxy(function() {
                    o.trigger("hold", [a.target]),
                    y.hold && (t = y.hold.call(o, a, a.target))
                }, this), y.longTapThreshold)),
                K(!0),
                null)
            }
        }
        function f(e) {
            ...
            if (L !== je && L !== Le && !$()) {
                var i, a, n, r, s, o, l, d, c, u, h, p, f = t.touches, g = te(f ? f[0] : t);
                if (R = se(),
                f && (O = f.length),
                y.hold && clearTimeout(I),
                L = Se,
                2 == O && (0 == x ? (ee(1, f[1]),
                x = T = re(P[0].start, P[1].start)) : (te(f[1]),
                T = re(P[0].end, P[1].end),
                P[0].end,
                P[1].end,
                S = C < 1 ? pe : he),
                C = (T / x * 1).toFixed(2),
                ...
                O === y.fingers || y.fingers === Te || !f || H()) {
                    ...
                    !y.triggerOnTouchEnd || y.triggerOnTouchLeave) {
                        ...
                        if (y.triggerOnTouchLeave) {
                            ...
                            a = g.end,
                            n = v,
                            m = a.x > n.left && a.x < n.right && a.y > n.top && a.y < n.bottom
                        }
                        !y.triggerOnTouchEnd && m ? L = Q(Se) : y.triggerOnTouchLeave && !m && (L = Q(je)),
                        L != Le && L != je || z(t, L)
                    }
                } else
                    z(t, L = Le);
        ...
        function g(e) {
            var t = e.originalEvent ? e.originalEvent : e
              , i = t.touches;
            return i && i.length ? (d = se(),
            c = event.touches.length + 1,
            !0) : ($() && (O = c),
            R = se(),
            b = ne(),
            F() || !D() ? z(t, L = Le) : y.triggerOnTouchEnd || 0 == y.triggerOnTouchEnd && L === Se ? (e.preventDefault(),
            z(t, L = je)) : !y.triggerOnTouchEnd && U() ? M(t, L = je, ye) : L === Se && z(t, L = Le),
            K(!1),
            null)
        }
        function m() {
        ...
        function Q(e) {
            var t = e
              ...
              , a = D()
              , n = F();
            return !i || n ? t = Le : !a || e != Se || y.triggerOnTouchEnd && !y.triggerOnTouchLeave ? !a && e == je && y.triggerOnTouchLeave && (t = Le) : t = je,
            t
        }
        function z(e, t) {
            var i, a = e.touches;
            return Y() || V() || W() || H() ? ((Y() || V()) && (i = M(e, t, me)),
            (W() || H()) && !1 !== i && (i = M(e, t, ve))) : Z() && G() && !1 !== i ? i = M(e, t, we) : b > y.longTapThreshold && w < Ce && y.longTap && !1 !== i ? i = M(e, t, _e) : 1 !== O && Oe || !(isNaN(w) || w < y.threshold) || !U() || !1 === i || (i = M(e, t, ye)),
            t === Le && m(),
            t === je && (a && a.length || m()),
            i
        }
        function M(e, t, i) {
            var a;
            if (i == me) {
                if (o.trigger("swipeStatus", [t, _ || null, w || 0, b || 0, O, P]),
                y.swipeStatus && !1 === (a = y.swipeStatus.call(o, e, t, _ || null, w || 0, b || 0, O, P)))
                    return !1;
                if (t == je && B()) {
                    if (o.trigger("swipe", [_, w, b, O, P]),
                    y.swipe && !1 === (a = y.swipe.call(o, e, _, w, b, O, P)))
                        return !1;
                    switch (_) {
                    case le:
                        o.trigger("swipeLeft", [_, w, b, O, P]),
                        y.swipeLeft && (a = y.swipeLeft.call(o, e, _, w, b, O, P));
                        break;
                    case de:
                        o.trigger("swipeRight", [_, w, b, O, P]),
                        y.swipeRight && (a = y.swipeRight.call(o, e, _, w, b, O, P));
                        break;
                    case ce:
                        o.trigger("swipeUp", [_, w, b, O, P]),
                        y.swipeUp && (a = y.swipeUp.call(o, e, _, w, b, O, P));
                        break;
                    case ue:
                        o.trigger("swipeDown", [_, w, b, O, P]),
                        y.swipeDown && (a = y.swipeDown.call(o, e, _, w, b, O, P))
                    }
                }
            }
            if (i == ve) {
                if (o.trigger("pinchStatus", [t, S || null, k || 0, b || 0, O, C, P]),
                y.pinchStatus && !1 === (a = y.pinchStatus.call(o, e, t, S || null, k || 0, b || 0, O, C, P)))
                    return !1;
                if (t == je && N())
                    switch (S) {
                    case he:
                        o.trigger("pinchIn", [S || null, k || 0, b || 0, O, C, P]),
                        y.pinchIn && (a = y.pinchIn.call(o, e, S || null, k || 0, b || 0, O, C, P));
                        break;
                    case pe:
                        o.trigger("pinchOut", [S || null, k || 0, b || 0, O, C, P]),
                        y.pinchOut && (a = y.pinchOut.call(o, e, S || null, k || 0, b || 0, O, C, P))
                    }
            }
            return i == ye ? t !== Le && t !== je || (clearTimeout(h),
            clearTimeout(I),
            G() && !Z() ? (u = se(),
            h = setTimeout(oe.proxy(function() {
                u = null,
                o.trigger("tap", [e.target]),
                y.tap && (a = y.tap.call(o, e, e.target))
            }, this), y.doubleTapThreshold)) : (u = null,
            o.trigger("tap", [e.target]),
            y.tap && (a = y.tap.call(o, e, e.target)))) : i == we ? t !== Le && t !== je || (clearTimeout(h),
            u = null,
            o.trigger("doubletap", [e.target]),
            y.doubleTap && (a = y.doubleTap.call(o, e, e.target))) : i == _e && (t !== Le && t !== je || (clearTimeout(h),
            u = null,
            o.trigger("longtap", [e.target]),
            y.longTap && (a = y.longTap.call(o, e, e.target)))),
            a
        }
        function D() {
            var e = !0;
            return null !== y.threshold && (e = w >= y.threshold),
            e
        }
        function F() {
            var e = !1;
            return null !== y.cancelThreshold && null !== _ && (e = ie(_) - w >= y.cancelThreshold),
            e
        }
        function E() {
        ...
        function K(e) {
            !0 === e ? (o.bind(a, f),
            o.bind(n, g),
            r && o.bind(r, v)) : (o.unbind(a, f, !1),
            o.unbind(n, g, !1),
            r && o.unbind(r, v, !1)),
            o.data(Ie + "_intouch", !0 === e)
        }
        function ee(e, t) {
            var i = void 0 !== t.identifier ? t.identifier : 0;
            return P[e].identifier = i,
            P[e].start.x = P[e].end.x = t.pageX || t.clientX,
            P[e].start.y = P[e].end.y = t.pageY || t.clientY,
            P[e]
        }
        function te(e) {
            var t = function(e) {
        ...
        this.option = function(e, t) {
            if (void 0 !== y[e]) {
                ...
                oe.error("Option " + e + " does not exist on jQuery.swipetp.options");
            return null
        }
    }
    oe.fn.swipetp = function(e) {
        ...
        if (i && "string" == typeof e) {
            ...
            return function(i) {
                ...
                i || (i = {});
                return i = oe.extend({}, oe.fn.swipetp.defaults, i),
                this.each(function() {
                    var e = oe(this)
                      , t = e.data(Ie);
                    t || (t = new a(this,i),
...
!function(p, f) {
    "use strict";
    var t, i, g = {}, a = p.document, m = p.GreenSockGlobals = p.GreenSockGlobals || p;
    if (!m.TweenLite) {
        var e, n, r, v, y, w = function(e) {
            ...
            for (t = 0; t < i.length; t++)
                a[i[t]] = a = a[i[t]] || {};
            return a
        }, u = w("com.greensock"), _ = 1e-10, l = function(e) {
            var t, i = [], a = e.length;
            for (t = 0; t !== a; i.push(e[t++]))
                ;
            return i
        }, b = function() {}, x = (t = Object.prototype.toString,
        i = t.call([]),
        function(e) {
            return null != e && (e instanceof Array || "object" == typeof e && !!e.push && t.call(e) === i)
        }
        ), T = {}, C = function(l, d, c, u) {
            this.sc = T[l] ? T[l].sc : [],
            (T[l] = this).gsClass = null,
            this.func = c;
            var h = [];
            this.check = function(e) {
                for (var t, i, a, n, r, s = d.length, o = s; -1 < --s; )
                    (t = T[d[s]] || new C(d[s],[])).gsClass ? (h[s] = t.gsClass,
                    o--) : e && t.sc.push(this);
                if (0 === o && c) {
                    if (a = (i = ("com.greensock." + l).split(".")).pop(),
                    n = w(i.join("."))[a] = this.gsClass = c.apply(c, h),
                    u)
                        if (m[a] = g[a] = n,
                        !(r = "undefined" != typeof module && module.exports) && "function" == typeof define && define.amd)
                            define((p.GreenSockAMDPath ? p.GreenSockAMDPath + "/" : "") + l.split(".").pop(), [], function() {
                                return n
                            });
                        else if (r)
                            if (l === f)
                                for (s in module.exports = g[f] = n,
                                g)
                                    n[s] = g[s];
                            else
                                g[f] && (g[f][a] = n);
        ...
        var o = [0, 0, 1, 1]
          ...
          , d = k.register = function(e, t, i, a) {
            for (var n, r, s, o, l = t.split(","), d = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); -1 < --d; )
                for (r = l[d],
                n = a ? h("easing." + r, null, !0) : u.easing[r] || {},
                s = c.length; -1 < --s; )
                    o = c[s],
                    S[r + "." + o] = S[o + r] = n[o] = e.getRatio ? e : e[o] || new e
        }
        ;
        ...
        n = (e = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; -1 < --n; )
            r = e[n] + ",Power" + n,
            d(new k(null,null,1,n), r, "easeOut", !0),
            d(new k(null,null,2,n), r, "easeIn" + (0 === n ? ",easeNone" : "")),
            d(new k(null,null,3,n), r, "easeInOut");
        ...
        (r = j.prototype).addEventListener = function(e, t, i, a, n) {
            n = n || 0;
            var r, s, o = this._listeners[e], l = 0;
            for (this !== v || y || v.wake(),
            null == o && (this._listeners[e] = o = []),
            s = o.length; -1 < --s; )
                (r = o[s]).c === t && r.s === i ? o.splice(s, 1) : 0 === l && r.pr < n && (l = s + 1);
            o.splice(l, 0, {
                c: t,
                s: i,
                up: a,
        ...
        var L = p.requestAnimationFrame
          ...
          , R = P();
        for (n = (e = ["ms", "moz", "webkit", "o"]).length; -1 < --n && !L; )
            L = p[e[n] + "RequestAnimationFrame"],
            O = p[e[n] + "CancelAnimationFrame"] || p[e[n] + "CancelRequestAnimationFrame"];
        h("Ticker", function(e, t) {
            var n, r, s, o, l, d = this, c = P(), i = !(!1 === t || !L) && "auto", u = 500, h = 33, p = function(e) {
                var t, i, a = P() - R;
                u < a && (c += a - h),
                R += a,
                d.time = (R - c) / 1e3,
            ...
            if (this._timeline) {
                ...
                this._timeline.smoothChildTiming) {
                    ...
                    var a = this._totalDuration
                      , n = this._timeline;
                    if (a < e && !i && (e = a),
                    this._startTime = (this._paused ? this._pauseTime : n._time) - (this._reversed ? a - e : e) / this._timeScale,
                ...
                (this._totalTime !== e || 0 === this._duration) && (M.length && J(),
                this.render(e, t, !1),
                M.length && J())
            }
            return this
        ...
        r.paused = function(e) {
            ...
            return e != this._paused && a && (y || e || v.wake(),
        ...
        var Q = h("TweenLite", function(e, t, i) {
            ...
            var a, n, r, s = e.jquery || e.length && e !== p && e[0] && (e[0] === p || e[0].nodeType && e[0].style && !e.nodeType), o = this.vars.overwrite;
            if (this._overwrite = o = null == o ? q[Q.defaultOverwrite] : "number" == typeof o ? o >> 0 : q[o],
            (s || e instanceof Array || e.push && x(e)) && "number" != typeof e[0])
                for (this._targets = r = l(e),
                this._propLookup = [],
                this._siblings = [],
                a = 0; a < r.length; a++)
                    (n = r[a]) ? "string" != typeof n ? n.length && n !== p && n[0] && (n[0] === p || n[0].nodeType && n[0].style && !n.nodeType) ? (r.splice(a--, 1),
                    this._targets = r = r.concat(l(n))) : (this._siblings[a] = $(n, this, !1),
                    1 === o && 1 < this._siblings[a].length && ee(n, this, null, 1, this._siblings[a])) : "string" == typeof (n = r[a--] = Q.selector(n)) && r.splice(a + 1, 1) : r.splice(a--, 1);
            else
                this._propLookup = {},
                this._siblings = $(e, this, !1),
                1 === o && 1 < this._siblings.length && ee(e, this, null, 1, this._siblings);
        ...
        var M = []
          ...
          , N = function(e, t, i, a) {
            ...
            o = 0; o < l; o++)
                ...
                c === n[o] || n.length <= o ? p += c : (p && (u.push(p),
                p = ""),
                s = parseFloat(n[o]),
                u.push(s),
                u._firstPT = {
          ...
          , H = function(e, t, i, a, n, r, s, o, l) {
            ...
            return ("number" != typeof u || "number" != typeof a && !h) && (s || isNaN(u) || !h && isNaN(a) || "boolean" == typeof u || "boolean" == typeof a ? (p.fp = s,
            p = {
          ...
          , J = W.lazyRender = function() {
            var e, t = M.length;
            for (D = {}; -1 < --t; )
                (e = M[t]) && !1 !== e._lazy && (e.render(e._lazy[0], e._lazy[1], !0),
                e._lazy = !1);
            M.length = 0
        }
        ;
        ...
        c._updateRoot = Q.render = function() {
            var e, t, i;
            if (M.length && J(),
            G.render((v.time - G._startTime) * G._timeScale, !1, !1),
            U.render((v.frame - U._startTime) * U._timeScale, !1, !1),
            M.length && J(),
            v.frame >= Z) {
                for (i in Z = v.frame + (parseInt(Q.autoSleep, 10) || 120),
                V) {
        ...
        var $ = function(e, t, i) {
          ...
          , K = function(e, t, i, a) {
            ...
            return s && (n = s(e, t, i, a)),
            (s = Q.onOverwrite) && (r = s(e, t, i, a)),
            !1 !== n && !1 !== r
        }
          , ee = function(e, t, i, a, n) {
            ...
            var d, c = t._startTime + _, u = [], h = 0, p = 0 === t._duration;
            for (r = n.length; -1 < --r; )
                (o = n[r]) === t || o._gc || o._paused || (o._timeline !== t._timeline ? (d = d || te(t, 0, p),
                0 === te(o, d, p) && (u[h++] = o)) : o._startTime <= c && o._startTime + o.totalDuration() / o._timeScale > c && ((p || !o._initted) && c - o._startTime <= 2e-10 || (u[h++] = o)));
            for (r = h; -1 < --r; )
                if (o = u[r],
                2 === a && o._kill(i, e, t) && (s = !0),
        ...
        r._init = function() {
            var e, t, i, a, n, r, s = this.vars, o = this._overwrittenProps, l = this._duration, d = !!s.immediateRender, c = s.ease;
            if (s.startAt) {
                for (a in this._startAt && (this._startAt.render(-1, !0),
                this._startAt.kill()),
                n = {},
                s.startAt)
                    n[a] = s.startAt[a];
                ...
                this._startAt = Q.to(this.target, 0, n),
                d)
                    if (0 < this._time)
                        this._startAt = null;
                    else if (0 !== l)
                ...
                if (this._startAt)
                    ...
                    for (a in 0 !== this._time && (d = !1),
                    i = {},
                    s)
                        X[a] && "autoCSS" !== a || (i[a] = s[a]);
                    if (i.overwrite = 0,
                    i.data = "isFromStart",
                    i.lazy = d && !1 !== s.lazy,
                    i.immediateRender = d,
                    this._startAt = Q.to(this.target, 0, i),
                    d) {
                        if (0 === this._time)
                            return
                    } else
            ...
            if (this._ease = c = c ? c instanceof k ? c : "function" == typeof c ? new k(c,s.easeParams) : S[c] || Q.defaultEase : Q.defaultEase,
            ...
            if (t && Q._onPluginEvent("_onInitAllProps", this),
        ...
        r._initProps = function(e, t, i, a, n) {
            ...
            this.vars.css || e.style && e !== p && e.nodeType && B.css && !1 !== this.vars.autoCSS && function(e, t) {
                var i, a = {};
                for (i in e)
                    X[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!B[i] || B[i] && B[i]._autoCSS) || (a[i] = e[i],
                    delete e[i]);
                e.css = a
            }(this.vars, e),
            this.vars)
                if (c = this.vars[r],
                X[r])
                    c && (c instanceof Array || c.push && x(c)) && -1 !== c.join("").indexOf("{self}") && (this.vars[r] = c = this._swapSelfInParams(c, this));
                    ...
                    t[r] = H.call(this, e, r, "get", c, r, 0, null, this.vars.stringFilter, n);
            return a && this._kill(a, e) ? this._initProps(e, t, i, a, n) : 1 < this._overwrite && this._firstPT && 1 < i.length && ee(e, this, t, this._overwrite, i) ? (this._kill(t, e),
            this._initProps(e, t, i, a, n)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (D[e._gsTweenID] = !0),
            o)
        }
        ,
        r.render = function(e, t, i) {
            var a, n, r, s, o = this._time, l = this._duration, d = this._rawPrevTime;
            if (l - 1e-7 <= e && 0 <= e)
                ...
                (d < 0 || e <= 0 && -1e-7 <= e || d === _ && "isPause" !== this.data) && d !== e && (i = !0,
                _ < d && (n = "onReverseComplete")),
                this._rawPrevTime = s = !t || e || d === e ? e : _);
            else if (e < 1e-7)
                this._totalTime = this._time = 0,
                this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                (0 !== o || 0 === l && 0 < d) && (n = "onReverseComplete",
                a = this._reversed),
                e < 0 && (this._active = !1,
                0 === l && (this._initted || !this.vars.lazy || i) && (0 <= d && (d !== _ || "isPause" !== this.data) && (i = !0),
                this._rawPrevTime = s = !t || e || d === e ? e : _)),
                this._initted || (i = !0);
            ...
            this._easeType) {
                ...
                this.ratio = 1 === u ? 1 - c : 2 === u ? c : e / l < .5 ? c / 2 : 1 - c / 2
            } else
        ...
        r._kill = function(e, t, i) {
            ...
            if ((x(t) || z(t)) && "number" != typeof t[0])
                ...
                if (this._targets) {
                    for (a = this._targets.length; -1 < --a; )
                        if (t === this._targets[a]) {
                            ...
                            n = this._overwrittenProps[a] = e ? this._overwrittenProps[a] || {} : "all";
                            break
                        }
                } else {
                    if (t !== this.target)
                ...
                if (o) {
                    ...
                    i && (Q.onOverwrite || this.vars.onOverwrite)) {
                        for (r in d)
                            o[r] && (u || (u = []),
                            u.push(r));
                        if ((u || !e) && !K(this, i, t, u))
                    ...
                    for (r in d)
                        (s = o[r]) && (h && (s.f ? s.t[s.p](s.s) : s.t[s.p] = s.s,
                        l = !0),
        ...
        ,
        r.invalidate = function() {
            return this._notifyPluginsOfEnabled && Q._onPluginEvent("_onDisable", this),
        ...
        r._enabled = function(e, t) {
            ...
            !(!this._notifyPluginsOfEnabled || !this._firstPT) && Q._onPluginEvent(e ? "_onEnable" : "_onDisable", this)
        }
        ,
        Q.to = function(e, t, i) {
            return new Q(e,t,i)
        ...
        Q.getTweensOf = function(e, t) {
            if (null == e)
                return [];
            var i, a, n, r;
            if (e = "string" != typeof e ? e : Q.selector(e) || e,
            (x(e) || z(e)) && "number" != typeof e[0]) {
                for (i = e.length,
                a = []; -1 < --i; )
                    a = a.concat(Q.getTweensOf(e[i], t));
                for (i = a.length; -1 < --i; )
                    for (r = a[i],
                    n = i; -1 < --n; )
                        r === a[n] && a.splice(i, 1)
            } else
                for (i = (a = $(e).concat()).length; -1 < --i; )
        ...
        Q.killTweensOf = Q.killDelayedCallsTo = function(e, t, i) {
            "object" == typeof t && (i = t,
            t = !1);
            for (var a = Q.getTweensOf(e, t), n = a.length; -1 < --n; )
                a[n]._kill(i, e)
        }
        ;
        ...
        s.plugin = function(e) {
            ...
            var t, i = e.propName, a = e.priority || 0, n = e.overwriteProps, r = {
                init: "_onInitTween",
                set: "setRatio",
                kill: "_kill",
                round: "_mod",
            ...
            }, !0 === e.global), o = s.prototype = new ie(i);
        ...
        e = p._gsQueue) {
            for (n = 0; n < e.length; n++)
                e[n]();
            for (r in T)
                T[r].func || p.console.log("GSAP encountered missing dependency: " + r)
        }
        y = !1
    }
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(c, u, h) {
        var p = function(e) {
            ...
            for (i in a)
                t = a[i],
                m(t) && -1 !== t.join("").indexOf("{self}") && (a[i] = this._swapSelfInParams(t));
          ...
          , r = t.pauseCallback = function(e, t, i, a) {
            var n, r = e._timeline, s = r._totalTime, o = e._startTime, l = e._rawPrevTime < 0 || 0 === e._rawPrevTime && r._reversed, d = l ? 0 : f, c = l ? f : 0;
            if (t || !this._forcingPlayhead) {
                for (r.pause(o),
                n = e._prev; n && n._startTime === o; )
                    n._rawPrevTime = c,
                    n = n._prev;
                for (n = e._next; n && n._startTime === o; )
                    n._rawPrevTime = d,
                    n = n._next;
                t && t.apply(a || r.vars.callbackScope || r, i || w),
                (this._forcingPlayhead || !r._paused) && r.seek(s)
            }
        }
          , b = function(e) {
            var t, i = [], a = e.length;
        ...
        i.staggerTo = function(e, t, i, a, n, r, s, o) {
            ...
            for ("string" == typeof e && (e = h.selector(e) || e),
            g(e = e || []) && (e = b(e)),
            (a = a || 0) < 0 && ((e = b(e)).reverse(),
            a *= -1),
            l = 0; e.length > l; l++)
                i.startAt && (i.startAt = _(i.startAt)),
                d.to(e[l], t, _(i), l * a);
            return this.add(d, n)
        }
        ,
        i.staggerFrom = function(e, t, i, a, n, r, s, o) {
            ...
            i.runBackwards = !0,
            this.staggerTo(e, t, i, a, n, r, s, o)
        }
        ,
        i.staggerFromTo = function(e, t, i, a, n, r, s, o, l) {
            return a.startAt = i,
            a.immediateRender = 0 != a.immediateRender && 0 != i.immediateRender,
            this.staggerTo(e, t, a, n, r, s, o, l)
        }
        ,
        ...
        i.set = function(e, t, i) {
            ...
            this.add(new h(e,0,t), i)
        }
        ,
        p.exportRoot = function(e, t) {
            null == (e = e || {}).smoothChildTiming && (e.smoothChildTiming = !0);
            var i, a, n = new p(e), r = n._timeline;
            for (null == t && (t = !0),
            r._remove(n, !0),
            n._startTime = 0,
            n._rawPrevTime = n._time = n._totalTime = r._time,
            i = r._first; i; )
                a = i._next,
                t && i instanceof h && i.target === i.vars.onComplete || n.add(i, i._startTime - i._delay),
                i = a;
            return r.add(n, 0),
            n
        }
        ...
        i.add = function(e, t, i, a) {
            ...
            if (u.prototype.add.call(this, e, t),
            (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())
                for (d = (l = this).rawTime() > e._startTime; l._timeline; )
        ...
        i._parseTimeOrLabel = function(e, t, i, a) {
            var n;
            if (a instanceof c && a.timeline === this)
                this.remove(a);
            else if (a && (a instanceof Array || a.push && m(a)))
                for (n = a.length; -1 < --n; )
                    a[n]instanceof c && a[n].timeline === this && this.remove(a[n]);
            if ("string" == typeof t)
                return this._parseTimeOrLabel(t, i && "number" == typeof e && null == this._labels[t] ? e - this.duration() : 0, i);
            if (t = t || 0,
            "string" != typeof e || !isNaN(e) && null == this._labels[e])
                null == e && (e = this.duration());
            else {
                if (-1 === (n = e.indexOf("=")))
                    return null == this._labels[e] ? i ? this._labels[e] = this.duration() + t : t : this._labels[e] + t;
                t = parseInt(e.charAt(n - 1) + "1", 10) * Number(e.substr(n + 1)),
                e = 1 < n ? this._parseTimeOrLabel(e.substr(0, n - 1), 0, i) : this.duration()
            }
            return Number(e) + t
        }
        ,
        ...
        i.render = function(e, t, i) {
            this._gc && this._enabled(!0, !1);
            var a, n, r, s, o, l = this._dirty ? this.totalDuration() : this._totalDuration, d = this._time, c = this._startTime, u = this._timeScale, h = this._paused;
            if (l <= e)
                this._totalTime = this._time = l,
                this._reversed || this._hasPausedChild() || (n = !0,
                s = "onComplete",
                o = !!this._timeline.autoRemoveChildren,
                0 === this._duration && (0 === e || this._rawPrevTime < 0 || this._rawPrevTime === f) && this._rawPrevTime !== e && this._first && (o = !0,
                this._rawPrevTime > f && (s = "onReverseComplete"))),
                this._rawPrevTime = this._duration || !t || e || this._rawPrevTime === e ? e : f,
                e = l + 1e-4;
            else if (e < 1e-7)
                if (this._totalTime = this._time = 0,
                (0 !== d || 0 === this._duration && this._rawPrevTime !== f && (0 < this._rawPrevTime || e < 0 && 0 <= this._rawPrevTime)) && (s = "onReverseComplete",
                n = this._reversed),
                e < 0)
                    this._active = !1,
                    ...
                    if (this._rawPrevTime = this._duration || !t || e || this._rawPrevTime === e ? e : f,
                    0 === e && n)
            ...
            if (this._time !== d && this._first || i || o) {
                ...
                this._time >= d)
                    ...
                    !this._paused || h); )
                        (a._active || d >= a._startTime && !a._paused && !a._gc) && (a._reversed ? a.render((a._dirty ? a.totalDuration() : a._totalDuration) - (e - a._startTime) * a._timeScale, t, i) : a.render((e - a._startTime) * a._timeScale, t, i)),
                        a = r;
                this._onUpdate && (t || (v.length && y(),
                this._callback("onUpdate"))),
                s && (this._gc || (c === this._startTime || u !== this._timeScale) && (0 === this._time || l >= this.totalDuration()) && (n && (v.length && y(),
        ...
        i.getChildren = function(e, t, i, a) {
            a = a || -9999999999;
            for (var n = [], r = this._first, s = 0; r; )
                a > r._startTime || (r instanceof h ? !1 !== t && (n[s++] = r) : (!1 !== i && (n[s++] = r),
                !1 !== e && (s = (n = n.concat(r.getChildren(!0, t, i))).length))),
                r = r._next;
            return n
        }
        ,
        i.getTweensOf = function(e, t) {
            var i, a, n = this._gc, r = [], s = 0;
            for (n && this._enabled(!0, !0),
            a = (i = h.getTweensOf(e)).length; -1 < --a; )
                (i[a].timeline === this || t && this._contains(i[a])) && (r[s++] = i[a]);
        ...
        i._kill = function(e, t) {
            if (!e && !t)
                return this._enabled(!1, !1);
            for (var i = t ? this.getTweensOf(t) : this.getChildren(!0, !0, !1), a = i.length, n = !1; -1 < --a; )
                i[a]._kill(e, t) && (n = !0);
            return n
        }
        ,
        ...
        i.totalDuration = function(e) {
            ...
            if (this._dirty) {
                for (var t, i, a = 0, n = this._last, r = 999999999999; n; )
                    ...
                    n._startTime < 0 && !n._paused && (a -= n._startTime,
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(m) {
        var t, i, e, a = _gsScope.GreenSockGlobals || _gsScope, n = a.com.greensock, r = 2 * Math.PI, s = Math.PI / 2, o = n._class, l = function(e, t) {
        ...
        (f = (t = o("easing.SteppedEase", function(e) {
            ...
            this._p1 = 1 / e,
            this._p2 = e + 1
        }, !0)).prototype = new m).constructor = t,
        f.getRatio = function(e) {
        ...
        (f = (i = o("easing.RoughEase", function(e) {
            for (var t, i, a, n, r, s, o = (e = e || {}).taper || "none", l = [], d = 0, c = 0 | (e.points || 20), u = c, h = !1 !== e.randomize, p = !0 === e.clamp, f = e.template instanceof m ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; -1 < --u; )
                t = h ? Math.random() : 1 / c * u,
                i = f ? f.getRatio(t) : t,
                a = "none" === o ? g : "out" === o ? (n = 1 - t) * n * g : "in" === o ? t * t * g : (n = t < .5 ? 2 * t : 2 * (1 - t)) * n * .5 * g,
                h ? i += Math.random() * a - .5 * a : u % 2 ? i += .5 * a : i -= .5 * a,
                p && (1 < i ? i = 1 : i < 0 && (i = 0)),
                l[d++] = {
                    x: t,
                    y: i
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(r, N) {
        ...
        }, d = _gsScope._gsDefine.globals, m = {}, e = H.prototype = new r("css");
        ...
        var j, v, y, W, w, k, L, O, t, i, P = /(?:\-|\.|\b)(\d|\.|e\-)+/g, R = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, c = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, I = /(?:\d|\-|\+|=|#|\.)*/g, A = /opacity *= *([^)]*)/i, b = /opacity:([^;]*)/i, s = /alpha\(opacity *=.+?\)/i, x = /^(rgb|hsl)/, o = /([A-Z])/g, l = /-([a-z])/gi, T = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, u = function(e, t) {
            return t.toUpperCase()
        }, p = /(?:Left|Right|Width)/i, h = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, Q = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, z = /,(?=[^\)]*(?:\(|$))/gi, M = /[\s,\(]/i, B = Math.PI / 180, V = 180 / Math.PI, D = {}, a = {
            style: {}
        }, F = _gsScope.document || {
        ...
        }, Y = E("div"), X = E("img"), n = H._internals = {
            _specialProps: m
        }, q = (_gsScope.navigator || {}).userAgent || "", U = (t = q.indexOf("Android"),
        i = E("a"),
        ...
        /^0.55/.test(i.style.opacity))), G = function(e) {
            ...
            a = 5; -1 < --a && void 0 === n[i[a] + e]; )
                ;
            return 0 <= a ? (J = "-" + ($ = 3 === a ? "ms" : i[a]).toLowerCase() + "-",
            $ + e) : null
        }, ee = F.defaultView ? F.defaultView.getComputedStyle : function() {}
        , te = H.getStyle = function(e, t, i, a, n) {
            var r;
            return U || "opacity" !== t ? (!a && e.style[t] ? r = e.style[t] : (i = i || ee(e)) ? r = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(o, "-$1").toLowerCase()) : e.currentStyle && (r = e.currentStyle[t]),
            null == n || r && "none" !== r && "auto" !== r && "auto auto" !== r ? r : n) : G(e)
        }
        , ie = n.convertToPixels = function(e, t, i, a, n) {
            ...
            if ("auto" === a || !i)
                return 0;
            var r, s, o, l = p.test(t), d = e, c = Y.style, u = i < 0, h = 1 === i;
            if (u && (i = -i),
            h && (i *= 100),
            "%" === a && -1 !== t.indexOf("border"))
                r = i / 100 * (l ? e.clientWidth : e.clientHeight);
            else {
                if (c.cssText = "border:0 solid red;position:" + te(e, "position") + ";line-height:0;",
                "%" !== a && d.appendChild && "v" !== a.charAt(0) && "rem" !== a)
                    c[l ? "borderLeftWidth" : "borderTopWidth"] = i + a;
                else {
                    if (s = (d = e.parentNode || F.body)._gsCache,
                    o = N.ticker.frame,
                    s && l && s.time === o)
                ...
                d.removeChild(Y),
                l && "%" === a && !1 !== H.cacheWidths && ((s = d._gsCache = d._gsCache || {}).time = o,
                s.width = r / i * 100),
        ...
        , ne = function(e, t) {
            ...
            if (t = t || ee(e, null))
                if (i = t.length)
                    for (; -1 < --i; )
                        (-1 === (n = t[i]).indexOf("-transform") || ze === n) && (r[n.replace(l, u)] = t.getPropertyValue(n));
                else
                    for (i in t)
                        (-1 === i.indexOf("Transform") || Qe === i) && (r[i] = t[i]);
            else if (t = e.currentStyle || e.style)
                for (i in t)
                    "string" == typeof i && void 0 === r[i] && (r[i.replace(l, u)] = t[i]);
            return U || (r.opacity = G(e)),
            a = Ue(e, t, !1),
            ...
            var r, s, o, l = {}, d = e.style;
            for (s in i)
                "cssText" !== s && "length" !== s && isNaN(s) && (t[s] !== (r = i[s]) || n && n[s]) && -1 === s.indexOf("Origin") && ("number" == typeof r || "string" == typeof r) && (l[s] = "auto" !== r || "left" !== s && "top" !== s ? "" !== r && "auto" !== r && "none" !== r || "string" != typeof t[s] || "" === t[s].replace(c, "") ? r : 0 : ae(e, s),
            ...
            var a = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight)
              , n = se[t]
              , r = n.length;
            for (i = i || ee(e, null); -1 < --r; )
                a -= parseFloat(te(e, "padding" + n[r], i, !0)) || 0,
                a -= parseFloat(te(e, "border" + n[r] + "Width", i, !0)) || 0;
            return a
        }, de = function(e, t) {
            if ("contain" === e || "auto" === e || "auto auto" === e)
                return e + " ";
            (null == e || "" === e) && (e = "0 0");
            var i, a = e.split(" "), n = -1 !== e.indexOf("left") ? "0%" : -1 !== e.indexOf("right") ? "100%" : a[0], r = -1 !== e.indexOf("top") ? "0%" : -1 !== e.indexOf("bottom") ? "100%" : a[1];
            if (3 < a.length && !t) {
            ...
            return "function" == typeof e && (e = e(O, L)),
            ...
            if (e)
                if ("number" == typeof e)
                    ...
                    pe[e])
                        ...
                        4 === e.length && (e = "#" + (a = e.charAt(1)) + a + (n = e.charAt(2)) + n + (r = e.charAt(3)) + r),
                        ...
                        t) {
                            ...
                            o = Number(i[1]) / 100,
                            a = 2 * (l = Number(i[2]) / 100) - (n = l <= .5 ? l * (o + 1) : l + o - l * o),
                            3 < i.length && (i[3] = Number(e[3])),
                            i[0] = fe(s + 1 / 3, a, n),
                            i[1] = fe(s, a, n),
                            i[2] = fe(s - 1 / 3, a, n);
                    else
                        i = e.match(P) || pe.transparent;
                    i[0] = Number(i[0]),
                    i[1] = Number(i[1]),
                    i[2] = Number(i[2]),
            ...
            d === c ? s = o = 0 : (u = d - c,
            o = .5 < l ? u / (2 - d - c) : u / (d + c),
            s = d === a ? (n - r) / u + (n < r ? 6 : 0) : d === n ? (r - a) / u + 2 : (a - n) / u + 4,
            s *= 60),
            i[0] = s + .5 | 0,
            i[1] = 100 * o + .5 | 0,
            i[2] = 100 * l + .5 | 0),
        ...
        , me = function(e, t) {
            var i, a, n, r = e.match(ve) || [], s = 0, o = r.length ? "" : e;
        ...
        var ye = function(e, t, r, s) {
            if (null == e)
                ...
                ;
            var o, l = t ? (e.match(ve) || [""])[0] : "", d = e.split(l).join("").match(_) || [], c = e.substr(0, e.indexOf(d[0])), u = ")" === e.charAt(e.length - 1) ? ")" : "", h = -1 !== e.indexOf(" ") ? " " : ",", p = d.length, f = 0 < p ? d[0].replace(P, "") : "";
            return p ? o = t ? function(e) {
                var t, i, a, n;
                if ("number" == typeof e)
                    e += f;
                else if (s && z.test(e)) {
                    for (n = e.replace(z, "|").split("|"),
                    a = 0; a < n.length; a++)
                        n[a] = o(n[a]);
                    return n.join(",")
                }
                if (t = (e.match(ve) || [l])[0],
                a = (i = e.split(t).join("").match(_) || []).length,
                p > a--)
                    for (; ++a < p; )
                        i[a] = r ? i[(a - 1) / 2 | 0] : d[a];
            ...
            : function(e) {
                ...
                if ("number" == typeof e)
                    ...
                    for (i = e.replace(z, "|").split("|"),
                    a = 0; a < i.length; a++)
                        i[a] = o(i[a]);
                    return i.join(",")
                }
                if (a = (t = e.match(_) || []).length,
                p > a--)
                    for (; ++a < p; )
                        t[a] = r ? t[(a - 1) / 2 | 0] : d[a];
                return c + t.join(h) + u
          ...
          , we = function(d) {
            ...
            function(e, t, i, a, n, r, s) {
                ...
                for (s = {},
                o = 0; o < 4; o++)
                    s[d[o]] = l[o] = l[o] || l[(o - 1) / 2 >> 0];
                return a.parse(e, s, n, r)
            }
        }
          , _e = (n._setPluginRatio = function(e) {
            this.plugin.setRatio(e);
            for (var t, i, a, n, r, s = this.data, o = s.proxy, l = s.firstMPT; l; )
                t = o[l.v],
        ...
        function(e, t, i, a, n) {
            ...
            this.v = i,
            this.r = n,
            a && ((a._prev = this)._next = a)
        }
        )
          , be = (n._parseToProxy = function(e, t, i, a, n, r) {
            var s, o, l, d, c, u = a, h = {}, p = {}, f = i._transform, g = D;
            ...
            r && (i._transform = f,
            u && (u._prev = null,
            u._prev && (u._prev._next = null))); a && a !== u; ) {
                if (a.type <= 1 && (p[o = a.p] = a.s + a.c,
                h[o] = a.s,
                r || (d = new _e(a,"s",o,d,a.r),
                a.c = 0),
                1 === a.type))
                    for (s = a.l; 0 < --s; )
                        l = "xn" + s,
                        p[o = a.p + "_" + l] = a.data[l],
                        h[o] = a[l],
                        r || (d = new _e(a,l,o,d,a.rxp[l]));
                a = a._next
            }
            return {
                proxy: h,
        ...
        n.CSSPropTween = function(e, t, i, a, n, r, s, o, l, d, c) {
          ...
          , Te = H.parseComplex = function(e, t, i, a, n, r, s, o, l, d) {
            i = i || r || "",
            "function" == typeof a && (a = a(O, L)),
            s = new be(e,t,0,0,s,d ? 2 : 1,null,!1,o,i,a),
            a += "",
            n && ve.test(a + i) && (a = [i, a],
            H.colorStringFilter(a),
            i = a[0],
            a = a[1]);
            var c, u, h, p, f, g, m, v, y, w, _, b, x, T = i.split(", ").join(",").split(" "), C = a.split(", ").join(",").split(" "), k = T.length, S = !1 !== j;
            for ((-1 !== a.indexOf(",") || -1 !== i.indexOf(",")) && (T = T.join(" ").replace(z, ", ").split(" "),
            C = C.join(" ").replace(z, ", ").split(" "),
            k = T.length),
            k !== C.length && (k = (T = (r || "").split(" ")).length),
            s.plugin = l,
            s.setRatio = d,
            c = ve.lastIndex = 0; c < k; c++)
                if (p = T[c],
                f = C[c],
                (v = parseFloat(p)) || 0 === v)
                    s.appendXtra("", v, ce(f, v), f.replace(R, ""), S && -1 !== f.indexOf("px"), !0);
                else if (n && ve.test(p))
                    b = ")" + ((b = f.indexOf(")") + 1) ? f.substr(b) : ""),
                    x = -1 !== f.indexOf("hsl") && U,
                    p = ge(p, x),
                    f = ge(f, x),
                    (y = 6 < p.length + f.length) && !U && 0 === f[3] ? (s["xs" + s.l] += s.l ? " transparent" : "transparent",
                    s.e = s.e.split(C[c]).join("transparent")) : (U || (y = !1),
                    x ? s.appendXtra(y ? "hsla(" : "hsl(", p[0], ce(f[0], p[0]), ",", !1, !0).appendXtra("", p[1], ce(f[1], p[1]), "%,", !1).appendXtra("", p[2], ce(f[2], p[2]), y ? "%," : "%" + b, !1) : s.appendXtra(y ? "rgba(" : "rgb(", p[0], f[0] - p[0], ",", !0, !0).appendXtra("", p[1], f[1] - p[1], ",", !0).appendXtra("", p[2], f[2] - p[2], y ? "," : b, !0),
                    y && (p = p.length < 4 ? 1 : p[3],
                    s.appendXtra("", p, (f.length < 4 ? 1 : f[3]) - p, b, !1))),
                    ve.lastIndex = 0;
                else if (g = p.match(P)) {
                    if (!(m = f.match(R)) || m.length !== g.length)
                        return s;
                    for (u = h = 0; u < g.length; u++)
                        _ = g[u],
                        w = p.indexOf(_, h),
                        s.appendXtra(p.substr(h, w - h), Number(_), ce(m[u], _), "", S && "px" === p.substr(w + _.length, 2), 0 === u),
                        h = w + _.length;
                    s["xs" + s.l] += p.substr(h)
                } else
          ...
          , Ce = 9;
        for ((e = be.prototype).l = e.pr = 0; 0 < --Ce; )
            e["xn" + Ce] = 0,
            e["xs" + Ce] = "";
        e.xs0 = "",
        ...
        e.appendXtra = function(e, t, i, a, n, r) {
            ...
            s.rxp["xn" + o] = n,
            s["xn" + o] = t,
            s.plugin || (s.xfirst = new be(s,"xn" + o,t,i,s.xfirst || s,0,s.n,n,s.pr),
        ...
        var ke = function(e, t) {
          ...
          , Se = n._registerComplexSpecialProp = function(e, t, i) {
            ...
            var a, n = e.split(","), r = t.defaultValue;
            for (i = i || [r],
            a = 0; a < n.length; a++)
            ...
            if (!m[e]) {
                ...
                Se(e, {
                    parser: function(e, t, i, a, n, r, s) {
                        ...
                        m[i].parse(e, t, i, a, n, r, s)) : (Z("Error: " + l + " js file not loaded."),
                        n)
                    }
                })
            }
        ...
        (e = ke.prototype).parseComplex = function(e, t, i, a, n, r) {
            ...
            if (this.multi && (z.test(i) || z.test(t) ? (o = t.replace(z, "|").split("|"),
            l = i.replace(z, "|").split("|")) : h && (o = [t],
            l = [i])),
            l) {
                for (d = l.length > o.length ? l.length : o.length,
                s = 0; s < d; s++)
                    t = o[s] = o[s] || this.dflt,
                    i = l[s] = l[s] || this.dflt,
                    h && ((c = t.indexOf(h)) !== (u = i.indexOf(h)) && (-1 === u ? o[s] = o[s].split(h).join("") : -1 === c && (o[s] += " " + h)));
                t = o.join(", "),
                i = l.join(", ")
            }
        ...
        var Le, Oe, Pe, Re, Ie, Ae = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Qe = K("transform"), ze = J + "transform", Me = K("transformOrigin"), De = null !== K("perspective"), Fe = n.Transform = function() {
            this.perspective = parseFloat(H.defaultTransformPerspective) || 0,
            this.force3D = !(!1 === H.defaultForce3D || !De) && (H.defaultForce3D || "auto")
        }
        , Ee = _gsScope.SVGElement, Ne = function(e, t, i) {
            var a, n = F.createElementNS("http://www.w3.org/2000/svg", e), r = /([a-z])([A-Z])/g;
            for (a in i)
                n.setAttributeNS(null, a.replace(r, "$1-$2").toLowerCase(), i[a]);
            return t.appendChild(n),
            n
        }, He = F.documentElement || {}, We = (Ie = k || /Android/i.test(q) && !_gsScope.chrome,
        F.createElementNS && !Ie && (Oe = Ne("svg", He),
        Re = (Pe = Ne("rect", Oe, {
            width: 100,
            height: 50,
            x: 100
        ...
        He.removeChild(Oe)),
        Ie), Be = function(e, t, i, a, n, r) {
            var s, o, l, d, c, u, h, p, f, g, m, v, y, w, _ = e._gsTransform, b = qe(e, !0);
            _ && (y = _.xOrigin,
            w = _.yOrigin),
            (!a || (s = a.split(" ")).length < 2) && (0 === (h = e.getBBox()).x && 0 === h.y && h.width + h.height === 0 && (h = {
            ...
            g = b[4],
            m = b[5],
            (v = u * f - h * p) && (o = d * (f / v) + c * (-p / v) + (p * m - f * g) / v,
            l = d * (-h / v) + c * (u / v) - (u * m - h * g) / v,
            d = i.xOrigin = s[0] = o,
            c = i.yOrigin = s[1] = l)),
            _ && (r && (i.xOffset = _.xOffset,
            i.yOffset = _.yOffset,
            _ = i),
            n || !1 !== n && !1 !== H.defaultSmoothOrigin ? (o = d - y,
            l = c - w,
            _.xOffset += o * b[0] + l * b[2] - o,
            _.yOffset += o * b[1] + l * b[3] - l) : _.xOffset = _.yOffset = 0),
            r || e.setAttribute("data-svg-origin", s.join(" "))
        }, Ve = function(e) {
            var t, i = E("svg", this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), a = this.parentNode, n = this.nextSibling, r = this.style.cssText;
            if (He.appendChild(i),
            i.appendChild(this),
            ...
            return n ? a.insertBefore(this, n) : a.appendChild(this),
            He.removeChild(i),
        ...
        }, Xe = [1, 0, 0, 1, 0, 0], qe = function(e, t) {
            var i, a, n, r, s, o, l = e._gsTransform || new Fe, d = e.style;
            if (Qe ? a = te(e, ze, null, !0) : e.currentStyle && (a = (a = e.currentStyle.filter.match(h)) && 4 === a.length ? [a[0].substr(4), Number(a[2].substr(4)), Number(a[1].substr(4)), a[3].substr(4), l.x || 0, l.y || 0].join(",") : ""),
            (i = !a || "none" === a || "matrix(1, 0, 0, 1, 0, 0)" === a) && Qe && ((o = "none" === ee(e).display) || !e.parentNode) && (o && (r = d.display,
            d.display = "block"),
            e.parentNode || (s = 1,
            He.appendChild(e)),
            ...
            s && He.removeChild(e)),
            (l.svg || e.getCTM && Ye(e)) && (i && -1 !== (d[Qe] + "").indexOf("matrix") && (a = d[Qe],
            i = 0),
            n = e.getAttribute("transform"),
            i && n && (-1 !== n.indexOf("matrix") ? (a = n,
            i = 0) : -1 !== n.indexOf("translate") && (a = "matrix(1,0,0,1," + n.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")",
            i = 0))),
            i)
                return Xe;
            for (n = (a || "").match(P) || [],
            Ce = n.length; -1 < --Ce; )
                r = Number(n[Ce]),
                n[Ce] = (s = r - (r |= 0)) ? (1e5 * s + (s < 0 ? -.5 : .5) | 0) / 1e5 + r : r;
            ...
            var n, r, s, o, l, d, c = i && e._gsTransform || new Fe, u = c.scaleX < 0, h = De && (parseFloat(te(e, Me, t, !1, "0 0 0").split(" ")[2]) || c.zOrigin) || 0, p = parseFloat(H.defaultTransformPerspective) || 0;
            if (c.svg = !(!e.getCTM || !Ye(e)),
            c.svg && (Be(e, te(e, Me, t, !1, "50% 50%") + "", c, e.getAttribute("data-svg-origin")),
            Le = H.useSVGTransformAttr || We),
            (n = qe(e)) !== Xe) {
                if (16 === n.length) {
                    var f, g, m, v, y, w = n[0], _ = n[1], b = n[2], x = n[3], T = n[4], C = n[5], k = n[6], S = n[7], j = n[8], L = n[9], O = n[10], P = n[12], R = n[13], I = n[14], A = n[11], Q = Math.atan2(k, O);
                    c.zOrigin && (P = j * (I = -c.zOrigin) - n[12],
                    R = L * I - n[13],
                    I = O * I + c.zOrigin - n[14]),
                    c.rotationX = Q * V,
                    Q && (f = T * (v = Math.cos(-Q)) + j * (y = Math.sin(-Q)),
                    g = C * v + L * y,
                    m = k * v + O * y,
                    j = T * -y + j * v,
                    L = C * -y + L * v,
                    ...
                    Q = Math.atan2(-b, O),
                    c.rotationY = Q * V,
                    Q && (g = _ * (v = Math.cos(-Q)) - L * (y = Math.sin(-Q)),
                    m = b * v - O * y,
                    L = _ * y + L * v,
                    O = b * y + O * v,
                    A = x * y + A * v,
                    ...
                    Q = Math.atan2(_, w),
                    c.rotation = Q * V,
                    Q && (w = w * (v = Math.cos(-Q)) + T * (y = Math.sin(-Q)),
                    g = _ * v + C * y,
                    C = _ * -y + C * v,
                    k = b * -y + k * v,
                    _ = g),
                    ...
                    c.scaleX = (1e5 * Math.sqrt(w * w + _ * _) + .5 | 0) / 1e5,
                    c.scaleY = (1e5 * Math.sqrt(C * C + L * L) + .5 | 0) / 1e5,
                    c.scaleZ = (1e5 * Math.sqrt(k * k + O * O) + .5 | 0) / 1e5,
                    c.rotationX || c.rotationY ? c.skewX = 0 : (c.skewX = T || C ? Math.atan2(T, C) * V + c.rotation : c.skewX || 0,
                    90 < Math.abs(c.skewX) && Math.abs(c.skewX) < 270 && (u ? (c.scaleX *= -1,
                    ...
                    c.y = R,
                    c.z = I,
                    c.svg && (c.x -= c.xOrigin - (c.xOrigin * w - c.yOrigin * T),
                    c.y -= c.yOrigin - (c.yOrigin * _ - c.xOrigin * C))
                    ...
                    90 < Math.abs(d) && Math.abs(d) < 270 && (u ? (s *= -1,
                    d += l <= 0 ? 180 : -180,
                    l += l <= 0 ? 180 : -180) : (o *= -1,
                    d += d <= 0 ? 180 : -180)),
                    c.scaleX = s,
                    ...
                    c.rotation = l,
                    c.skewX = d,
                    De && (c.rotationX = c.rotationY = c.z = 0,
                    c.perspective = p,
                    c.scaleZ = 1),
                    c.svg && (c.x -= c.xOrigin - (c.xOrigin * M + c.yOrigin * F),
                    c.y -= c.yOrigin - (c.xOrigin * D + c.yOrigin * E))
                }
                for (r in c.zOrigin = h,
                c)
                    c[r] < 2e-5 && -2e-5 < c[r] && (c[r] = 0)
            }
        ...
        , Ge = function(e) {
            var t, i, a = this.data, n = -a.rotation * B, r = n + a.skewX * B, s = 1e5, o = (Math.cos(n) * a.scaleX * s | 0) / s, l = (Math.sin(n) * a.scaleX * s | 0) / s, d = (Math.sin(r) * -a.scaleY * s | 0) / s, c = (Math.cos(r) * a.scaleY * s | 0) / s, u = this.t.style, h = this.t.currentStyle;
            if (h) {
                i = l,
                l = -d,
                d = -i,
                t = h.filter,
                u.filter = "";
                var p, f, g = this.t.offsetWidth, m = this.t.offsetHeight, v = "absolute" !== h.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + o + ", M12=" + l + ", M21=" + d + ", M22=" + c, w = a.x + g * a.xPercent / 100, _ = a.y + m * a.yPercent / 100;
                if (null != a.ox && (w += (p = (a.oxp ? g * a.ox * .01 : a.ox) - g / 2) - (p * o + (f = (a.oyp ? m * a.oy * .01 : a.oy) - m / 2) * l),
                _ += f - (p * d + f * c)),
                ...
                (0 === e || 1 === e) && 1 === o && 0 === l && 0 === d && 1 === c && (v && -1 === y.indexOf("Dx=0, Dy=0") || A.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter")),
                !v) {
                    var b, x, T, C = k < 8 ? 1 : -1;
                    for (p = a.ieOffsetX || 0,
                    f = a.ieOffsetY || 0,
                    ...
                    Ce = 0; Ce < 4; Ce++)
                        T = (i = -1 !== (b = h[x = oe[Ce]]).indexOf("px") ? parseFloat(b) : ie(this.t, x, parseFloat(b), b.replace(I, "")) || 0) !== a[x] ? Ce < 2 ? -a.ieOffsetX : -a.ieOffsetY : Ce < 2 ? p - a.ieOffsetX : f - a.ieOffsetY,
                        u[x] = (a[x] = Math.round(i - T * (0 === Ce || 2 === Ce ? 1 : C))) + "px"
                }
            }
        }, Ze = n.set3DTransformRatio = n.setTransformRatio = function(e) {
            var t, i, a, n, r, s, o, l, d, c, u, h, p, f, g, m, v, y, w, _, b, x, T, C = this.data, k = this.t.style, S = C.rotation, j = C.rotationX, L = C.rotationY, O = C.scaleX, P = C.scaleY, R = C.scaleZ, I = C.x, A = C.y, Q = C.z, z = C.svg, M = C.perspective, D = C.force3D, F = C.skewY, E = C.skewX;
            if (F && (E += F,
            S += F),
            !((1 !== e && 0 !== e || "auto" !== D || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && D || Q || M || L || j || 1 !== R) || Le && z || !De)
                S || E || z ? (S *= B,
                x = E * B,
                T = 1e5,
                i = Math.cos(S) * O,
                ...
                a = Math.sin(S - x) * -P,
                s = Math.cos(S - x) * P,
                x && "simple" === C.skewType && (t = Math.tan(x - F * B),
                a *= t = Math.sqrt(1 + t * t),
                s *= t,
                F && (t = Math.tan(F * B),
                i *= t = Math.sqrt(1 + t * t),
                r *= t)),
                z && (I += C.xOrigin - (C.xOrigin * i + C.yOrigin * a) + C.xOffset,
                A += C.yOrigin - (C.xOrigin * r + C.yOrigin * s) + C.yOffset,
                Le && (C.xPercent || C.yPercent) && (g = this.t.getBBox(),
                I += .01 * C.xPercent * g.width,
                A += .01 * C.yPercent * g.height),
                I < (g = 1e-6) && -g < I && (I = 0),
                A < g && -g < A && (A = 0)),
                w = (i * T | 0) / T + "," + (r * T | 0) / T + "," + (a * T | 0) / T + "," + (s * T | 0) / T + "," + I + "," + A + ")",
                z && Le ? this.t.setAttribute("transform", "matrix(" + w) : k[Qe] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + w) : k[Qe] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + O + ",0,0," + P + "," + I + "," + A + ")";
            else {
                if (W && (O < (g = 1e-4) && -g < O && (O = R = 2e-5),
                P < g && -g < P && (P = R = 2e-5),
                !M || C.z || C.rotationX || C.rotationY || (M = 0)),
                S || E)
                    S *= B,
                    m = i = Math.cos(S),
                    v = r = Math.sin(S),
                    ...
                    m = Math.cos(S),
                    v = Math.sin(S),
                    "simple" === C.skewType && (t = Math.tan((E - F) * B),
                    m *= t = Math.sqrt(1 + t * t),
                    v *= t,
                    C.skewY && (t = Math.tan(F * B),
                    i *= t = Math.sqrt(1 + t * t),
                    r *= t))),
                    a = -v,
                    s = m;
                    ...
                    if (!(L || j || 1 !== R || M || z))
                        return void (k[Qe] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + I + "px," + A + "px," + Q + "px)" + (1 !== O || 1 !== P ? " scale(" + O + "," + P + ")" : ""));
                    i = s = 1,
                    a = r = 0
                }
                c = 1,
                ...
                i *= m,
                r *= m),
                (S = j * B) && (t = a * (m = Math.cos(S)) + n * (v = Math.sin(S)),
                y = s * m + o * v,
                d = c * v,
                h = p * v,
                n = a * -v + n * m,
                ...
                j || L || 1 !== R ? (w += _ + (d < g && -g < d ? b : d) + _ + (h < g && -g < h ? b : h) + _ + (n < g && -g < n ? b : n),
                w += _ + (o < g && -g < o ? b : o) + _ + (c < g && -g < c ? b : c) + _ + (p < g && -g < p ? b : p) + _) : w += ",0,0,0,0,1,0,",
        ...
        Se("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(e, t, i, a, n, r, s) {
                if (a._lastParsedTransform === s)
                    return n;
                var o, l = (a._lastParsedTransform = s).scale && "function" == typeof s.scale ? s.scale : 0;
                "function" == typeof s[i] && (o = s[i],
                s[i] = t),
                l && (s.scale = l(O, e));
                var d, c, u, h, p, f, g, m, v, y = e._gsTransform, w = e.style, _ = Ae.length, b = s, x = {}, T = "transformOrigin", C = Ue(e, S, !0, b.parseTransform), k = b.transform && ("function" == typeof b.transform ? b.transform(O, L) : b.transform);
                if (a._transform = C,
                k && "string" == typeof k && Qe)
                    (c = Y.style)[Qe] = k,
                    c.display = "block",
                    c.position = "absolute",
                    ...
                    Be(e, de(b.transformOrigin), k, b.svgOrigin, b.smoothOrigin, !0),
                    f = k.xOrigin,
                    g = k.yOrigin,
                    d.x -= k.xOffset - C.xOffset,
                    d.y -= k.yOffset - C.yOffset),
                    (f || g) && (m = qe(Y, !0),
                    d.x -= f - (f * m[0] + g * m[2]),
                    d.y -= g - (f * m[1] + g * m[3]))),
                    ...
                    null != (p = b.directionalRotation))
                        if ("object" == typeof p)
                            ...
                            b.rotation = p;
                    "string" == typeof b.x && -1 !== b.x.indexOf("%") && (d.x = 0,
                    d.xPercent = ue(b.x, C.xPercent)),
                    "string" == typeof b.y && -1 !== b.y.indexOf("%") && (d.y = 0,
                    d.yPercent = ue(b.y, C.yPercent)),
                    ...
                    De && (d.rotationX = he("rotationX"in b ? b.rotationX : "shortRotationX"in b ? b.shortRotationX + "_short" : C.rotationX || 0, C.rotationX, "rotationX", x),
                ...
                for (De && null != b.force3D && (C.force3D = b.force3D,
                h = !0),
                C.skewType = b.skewType || C.skewType || H.defaultSkewType,
                (u = C.force3D || C.z || C.rotationX || C.rotationY || d.z || d.rotationX || d.rotationY || d.perspective) || null == b.scale || (d.scaleZ = 1); -1 < --_; )
                    (1e-6 < (k = d[v = Ae[_]] - C[v]) || k < -1e-6 || null != b[v] || null != D[v]) && (h = !0,
                    n = new be(C,v,C[v],k,n),
                    v in x && (n.e = x[v]),
                    n.xs0 = 0,
                    n.plugin = r,
                    a._overwriteProps.push(n.n));
                return k = b.transformOrigin,
                C.svg && (k || b.svgOrigin) && (f = C.xOffset,
                g = C.yOffset,
                ...
                (f !== C.xOffset || g !== C.yOffset) && (n = xe(C, "xOffset", y ? f : C.xOffset, C.xOffset, n, T),
                n = xe(C, "yOffset", y ? g : C.yOffset, C.yOffset, n, T)),
                k = "0px 0px"),
                (k || De && u && C.zOrigin) && (Qe ? (h = !0,
                v = Me,
                k = (k || te(e, v, S, !1, "50% 50%")) + "",
                (n = new be(w,v,0,0,n,-1,T)).b = w[v],
                n.plugin = r,
                n.xs0 = n.e = De ? (c = C.zOrigin,
                k = k.split(" "),
        ...
        Se("borderRadius", {
            ...
            parser: function(e, t, i, a, n, r) {
                t = this.format(t);
                var s, o, l, d, c, u, h, p, f, g, m, v, y, w, _, b, x = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], T = e.style;
                for (f = parseFloat(e.offsetWidth),
                g = parseFloat(e.offsetHeight),
                s = t.split(" "),
                o = 0; o < x.length; o++)
                    this.p.indexOf("border") && (x[o] = K(x[o])),
                    -1 !== (c = d = te(e, x[o], S, !1, "0px")).indexOf(" ") && (c = (d = c.split(" "))[0],
                    d = d[1]),
                    u = l = s[o],
                    h = parseFloat(c),
                    v = c.substr((h + "").length),
                    "" === (m = (y = "=" === u.charAt(1)) ? (p = parseInt(u.charAt(0) + "1", 10),
                    u = u.substr(2),
                    p *= parseFloat(u),
                    u.substr((p + "").length - (p < 0 ? 1 : 0)) || "") : (p = parseFloat(u),
                    u.substr((p + "").length))) && (m = C[i] || v),
                    m !== v && (w = ie(e, "borderLeft", h, v),
                    _ = ie(e, "borderTop", h, v),
                    d = "%" === m ? (c = w / f * 100 + "%",
                    _ / g * 100 + "%") : "em" === m ? (c = w / (b = ie(e, "borderLeft", 1, "em")) + "em",
                    _ / b + "em") : (c = w + "px",
                    _ + "px"),
                    y && (u = parseFloat(c) + p + m,
                    l = parseFloat(d) + p + m)),
        ...
        Se("backgroundPosition", {
            defaultValue: "0 0",
            parser: function(e, t, i, a, n, r) {
                var s, o, l, d, c, u, h = "background-position", p = S || ee(e, null), f = this.format((p ? k ? p.getPropertyValue(h + "-x") + " " + p.getPropertyValue(h + "-y") : p.getPropertyValue(h) : e.currentStyle.backgroundPositionX + " " + e.currentStyle.backgroundPositionY) || "0 0"), g = this.format(t);
                if (-1 !== f.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && ((u = te(e, "backgroundImage").replace(T, "")) && "none" !== u)) {
                    for (s = f.split(" "),
                    o = g.split(" "),
                    X.setAttribute("src", u),
                    l = 2; -1 < --l; )
                        (d = -1 !== (f = s[l]).indexOf("%")) !== (-1 !== o[l].indexOf("%")) && (c = 0 === l ? e.offsetWidth - X.width : e.offsetHeight - X.height,
                        s[l] = d ? parseFloat(f) / 100 * c + "px" : parseFloat(f) / c * 100 + "%");
                    f = s.join(" ")
                }
        ...
        Se("clip", {
            ...
            parser: function(e, t, i, a, n, r) {
                ...
                this.format(t).split(",").join(l)) : (s = this.format(te(e, this.p, S, !1, this.dflt)),
                this.format(t)),
        ...
        var Je = function(e) {
            var t, i = this.t, a = i.filter || te(this.data, "filter") || "", n = this.s + this.c * e | 0;
            100 === n && (t = -1 === a.indexOf("atrix(") && -1 === a.indexOf("radient(") && -1 === a.indexOf("oader(") ? (i.removeAttribute("filter"),
            !te(this.data, "filter")) : (i.filter = a.replace(s, ""),
            !0)),
            t || (this.xn1 && (i.filter = a = a || "alpha(opacity=" + n + ")"),
            -1 === a.indexOf("pacity") ? 0 === n && this.xn1 || (i.filter = a + " alpha(opacity=" + n + ")") : i.filter = a.replace(A, "opacity=" + n))
        };
        Se("opacity,alpha,autoAlpha", {
            ...
            parser: function(e, t, i, a, n, r) {
                ...
                U ? n = new be(o,"opacity",s,t - s,n) : ((n = new be(o,"opacity",100 * s,100 * (t - s),n)).xn1 = l ? 1 : 0,
                o.zoom = 1,
                n.type = 2,
                ...
                n.plugin = r,
                n.setRatio = Je),
                l && ((n = new be(o,"visibility",0,0,n,-1,null,!1,0,0 !== s ? "inherit" : "hidden",0 === t ? "hidden" : "inherit")).xs0 = "inherit",
                a._overwriteProps.push(n.n),
        ...
        Se("className", {
            parser: function(e, t, i, a, n, r, s) {
                var o, l, d, c, u, h = e.getAttribute("class") || "", p = e.style.cssText;
                if ((n = a._classNamePT = new be(e,i,0,0,n,2)).setRatio = Ke,
                n.pr = -11,
                f = !0,
                n.b = h,
                l = ne(e, S),
                ...
                return (e._gsClassPT = n).e = "=" !== t.charAt(1) ? t : h.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""),
        ...
        var et = function(e) {
            if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var t, i, a, n, r, s = this.t.style, o = m.transform.parse;
                if ("all" === this.e)
                    n = !(s.cssText = "");
                else
                    for (a = (t = this.e.split(" ").join("").split(",")).length; -1 < --a; )
                        i = t[a],
                        m[i] && (m[i].parse === o ? n = !0 : i = "transformOrigin" === i ? Me : m[i].p),
                        $e(s, i);
                n && ($e(s, Qe),
        ...
        for (Se("clearProps", {
            parser: function(e, t, i, a, n) {
                return (n = new be(e,i,0,0,n,2)).setRatio = et,
                n.e = t,
                n.pr = -10,
                n.data = a._tween,
                f = !0,
        ...
        e._onInitTween = function(e, t, i, a) {
            ...
            j = t.autoRound,
            f = !1,
            C = t.suffixMap || H.suffixMap,
            S = ee(e, ""),
            g = this._overwriteProps;
            var n, r, s, o, l, d, c, u, h, p = e.style;
            if (v && "" === p.zIndex && (("auto" === (n = te(e, "zIndex", S)) || "" === n) && this._addLazySet(p, "zIndex", 0)),
            "string" == typeof t && (o = p.cssText,
            n = ne(e, S),
            p.cssText = o + ";" + t,
            n = re(e, n, ne(e)).difs,
            !U && b.test(t) && (n.opacity = parseFloat(RegExp.$1)),
            t = n,
            p.cssText = o),
            ...
            this._transformType) {
                ...
                w && this._addLazySet(p, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (h ? "visible" : "hidden"))) : p.zoom = 1,
                s = r; s && s._next; )
                    s = s._next;
                u = new be(e,"transform",0,0,null,2),
                this._linkCSSP(u, null, s),
                u.setRatio = Qe ? Ze : Ge,
                u.data = this._transform || Ue(e, S, !0),
                u.tween = i,
                u.pr = -1,
                g.pop()
            }
            if (f) {
                for (; r; ) {
                    ...
                    s = o; s && s.pr > r.pr; )
                        s = s._next;
                    (r._prev = s ? s._prev : l) ? r._prev._next = r : o = r,
                    (r._next = s) ? s._prev = r : l = r,
                    r = d
                }
                this._firstPT = o
            }
        ...
        e.parse = function(e, t, i, a) {
            ...
            for (n in t)
                ...
                (r = m[n]) ? i = r.parse(e, d, n, this, i, a, t) : (l = te(e, n, S) + "",
                h = "string" == typeof d,
                "color" === n || "fill" === n || "stroke" === n || -1 !== n.indexOf("Color") || h && x.test(d) ? (h || (d = (3 < (d = ge(d)).length ? "rgba(" : "rgb(") + d.join(",") + ")"),
                i = Te(f, n, l, d, !0, "transparent", i, 0, a)) : h && M.test(d) ? i = Te(f, n, l, d, !0, null, i, 0, a) : (c = (s = parseFloat(l)) || 0 === s ? l.substr((s + "").length) : "",
                ("" === l || "auto" === l) && (c = "width" === n || "height" === n ? (s = le(e, n, S),
                "px") : "left" === n || "top" === n ? (s = ae(e, n, S),
                "px") : (s = "opacity" !== n ? 0 : 1,
                "")),
                "" === (u = (p = h && "=" === d.charAt(1)) ? (o = parseInt(d.charAt(0) + "1", 10),
                d = d.substr(2),
                o *= parseFloat(d),
                d.replace(I, "")) : (o = parseFloat(d),
                h ? d.replace(I, "") : "")) && (u = n in C ? C[n] : c),
                d = o || 0 === o ? (p ? o + s : o) + u : t[n],
                c !== u && "" !== u && (o || 0 === o) && s && (s = ie(e, n, s, c),
                "%" === u ? (s /= ie(e, n, 100, "%") / 100,
                !0 !== t.strictUnits && (l = s + "%")) : "em" === u || "rem" === u || "vw" === u || "vh" === u ? s /= ie(e, n, 1, u) : "px" !== u && (o = ie(e, n, o, u),
                u = "px"),
                p && (o || 0 === o) && (d = o + s + u)),
                p && (o += s),
                !s && 0 !== s || !o && 0 !== o ? void 0 !== f[n] && (d || d + "" != "NaN" && null != d) ? (i = new be(f,n,o || s || 0,0,i,-1,n,!1,0,l,d)).xs0 = "none" !== d || "display" !== n && -1 === n.indexOf("Style") ? d : l : Z("invalid " + n + " tween value: " + t[n]) : (i = new be(f,n,s,o - s,i,0,n,!1 !== j && ("px" === u || "zIndex" === n),0,l,d)).xs0 = u)),
        ...
        e._enableTransforms = function(e) {
            this._transform = this._transform || Ue(this._target, S, !0),
            this._transformType = this._transform.svg && Le || !e && 3 !== this._transformType ? 2 : 3
        }
        ;
        var tt = function(e) {
        ...
        e._kill = function(e) {
            ...
            for (e.className && (t = this._classNamePT) && ((a = t.xfirst) && a._prev ? this._linkCSSP(a._prev, t._next, a._prev._prev) : a === this._firstPT && (this._firstPT = t._next),
        ...
        var it = function(e, t, i) {
            ...
            if (e.slice)
                ...
                for (n = (a = e.childNodes).length; -1 < --n; )
                    s = (r = a[n]).type,
                    r.style && (t.push(ne(r)),
                    i && i.push(r)),
                    1 !== s && 9 !== s && 11 !== s || !r.childNodes.length || it(r, t, i)
        };
        return H.cascadeTo = function(e, t, i) {
            var a, n, r, s, o = N.to(e, t, i), l = [o], d = [], c = [], u = [], h = N._internals.reservedProps;
...
!function(i) {
    ...
    var n = i.GreenSockGlobals || i
      ...
      , B = function(e, t, i, a) {
        var n;
        return (i = i || W(e, null)) ? n = (e = i.getPropertyValue(t.replace(r, "-$1").toLowerCase())) || i.length ? e : i[t] : e.currentStyle && (n = (i = e.currentStyle)[t]),
        a ? n : parseInt(n, 10) || 0
    }
      , s = function(e) {
      ...
      , a = e.SplitText = n.SplitText = function(e, t) {
        if ("string" == typeof e && (e = a.selector(e)),
        !e)
      ...
      , V = function(e, t, i) {
        ...
        if (1 === a || 9 === a || 11 === a)
            ...
            (3 === a || 4 === a) && (e.nodeValue = e.nodeValue.split(t).join(i))
    }
      , Y = function(e, t) {
      ...
      , c = function(e, t, i, a, n, r, s) {
        ...
        if (Q || D)
            for (o = 0; o < d; o++)
                ((h = (c = u[o]).parentNode === e) || D || M && !z) && (y = c.offsetTop,
                Q && h && Math.abs(y - b) > S && "BR" !== c.nodeName && (p = [],
                Q.push(p),
                b = y),
                D && (c._x = c.offsetLeft,
                c._y = y,
                c._w = c.offsetWidth,
                c._h = c.offsetHeight),
                Q && ((c._isSplit && h || !M && h || z && h || !z && c.parentNode.parentNode === e && !c.parentNode._isSplit) && (p.push(c),
                c._x -= _,
                X(c, e, R) && (c._wordEnd = !0)),
                "BR" === c.nodeName && c.nextSibling && "BR" === c.nextSibling.nodeName && Q.push([])));
        for (o = 0; o < d; o++)
            h = (c = u[o]).parentNode === e,
            "BR" !== c.nodeName ? (D && (g = c.style,
            z || h || (c._x += c.parentNode._x,
            ...
            g.width = c._w + 1 + "px",
            g.height = c._h + "px"),
            !z && M ? c._isSplit ? (c._next = c.nextSibling,
            ...
            u.splice(o--, 1),
            d--) : h || (y = !c.nextSibling && X(c.parentNode, e, R),
            ...
            L.push(c)) : c.parentNode._isSplit && !c._isSplit && "" !== c.innerHTML ? O.push(c) : M && !c._isSplit && (t.span && (c.style.display = "inline"),
            L.push(c))) : Q || D ? (c.parentNode && c.parentNode.removeChild(c),
            u.splice(o--, 1),
            d--) : z || e.appendChild(c);
        for (o = N.length; -1 < --o; )
            N[o].parentNode.removeChild(N[o]);
        if (Q) {
            for (D && (m = H.createElement(I),
            e.appendChild(m),
            v = m.offsetWidth + "px",
            ...
            o = 0; o < Q.length; o++) {
                for (p = Q[o],
                (m = H.createElement(I)).style.cssText = "display:block;text-align:" + j + ";position:" + (D ? "absolute;" : "relative;"),
                F && (m.className = F + (E ? o + 1 : "")),
                P.push(m),
                d = p.length,
                l = 0; l < d; l++)
                    "BR" !== p[l].nodeName && (c = p[l],
                    m.appendChild(c),
                    f && c._wordEnd && m.appendChild(H.createTextNode(" ")),
                    D && (0 === l && (m.style.top = c._y + "px",
                    m.style.left = _ + y + "px"),
                    c.style.top = "0px",
                    y && (c.style.left = c._x - y + "px")));
                0 === d ? m.innerHTML = "&nbsp;" : z || M || (q(m),
        ...
        D && (s > e.clientHeight && (e.style.height = s - C + "px",
        e.clientHeight < s && (e.style.height = s + x + "px")),
        r > e.clientWidth && (e.style.width = r - k + "px",
        e.clientWidth < r && (e.style.width = r + T + "px"))),
        Y(i, L),
        Y(a, O),
        Y(n, P)
    }
      , u = function(e, t, i, a) {
        var n, r, s = d(e.childNodes), o = s.length, l = "absolute" === t.position || !0 === t.absolute;
        if (3 !== e.nodeType || 1 < o) {
            for (t.absolute = !1,
            n = 0; n < o; n++)
                (3 !== (r = s[n]).nodeType || /\S+/.test(r.nodeValue)) && (l && 3 !== r.nodeType && "inline" === B(r, "display", null, !0) && (r.style.display = "inline-block",
        ...
        !function(e, t, i, a) {
            var n, r, s, o, l, d, c, u, h, p = t.span ? "span" : "div", f = t.type || t.split || "chars,words,lines", g = (f.indexOf("words"),
            -1 !== f.indexOf("chars")), m = "absolute" === t.position || !0 === t.absolute, v = t.wordDelimiter || " ", y = " " !== v ? "" : m ? "&#173; " : " ", w = t.span ? "</span>" : "</div>", _ = !0, b = H.createElement("div"), x = e.parentNode;
            for (x.insertBefore(b, e),
            ...
            s = 0; s < l; s++)
                if ((d = n.charAt(s)) === v && n.charAt(s - 1) !== v && s) {
                    ...
                    _ = !1; n.charAt(s + 1) === v; )
                        r += y,
                        s++;
                    s === l - 1 ? r += y : ")" !== n.charAt(s + 1) && (r += y + i(),
                    _ = !0)
                } else
                    "{" === d && "{{LT}}" === n.substr(s, 6) ? (r += g ? a() + "{{LT}}</" + p + ">" : "{{LT}}",
                    s += 5) : 55296 <= d.charCodeAt(0) && d.charCodeAt(0) <= 56319 || 65024 <= n.charCodeAt(s + 1) && n.charCodeAt(s + 1) <= 65039 ? (u = S(n.substr(s, 2)),
                    h = S(n.substr(s + 2, 2)),
    ...
    t.split = function(e) {
        ...
        for (var t, i, a, n = this.elements.length, r = e.span ? "span" : "div", s = ("absolute" === e.position || e.absolute,
        l(e.wordsClass, r)), o = l(e.charsClass, r); -1 < --n; )
            a = this.elements[n],
            this._originals[n] = a.innerHTML,
            t = a.clientHeight,
            i = a.clientWidth,
            u(a, e, s, o),
            c(a, e, this.chars, this.words, this.lines, i, t);
...
!function(c, e) {
    ...
    c.expr[":"].uncached = function(e) {
        ...
        return t.src = e.src,
        c(e).is('img[src!=""]') && !t.complete
    }
    ,
    c.fn.waitForImages = function(l, d, t) {
        if (c.isPlainObject(l) && (d = l.each,
        t = l.waitForAll,
        l = l.finished),
        l = l || c.noop,
        d = d || c.noop,
        t = !!t,
        !c.isFunction(l) || !c.isFunction(d))
        ...
        return this.each(function() {
            ...
            c.each(r, function(e, t) {
                ...
                c(i).bind("load error", function(e) {
                    if (o++,
                    d.call(t.element, o, n, "load" == e.type),
                    o == n)
                        return l.call(a[0]),
                        !1
                }),
...
function($) {
    ...
    function getScrollRoot() {
        var e, t = document.documentElement, i = document.body, a = (void 0 !== window.pageYOffset ? window.pageYOffset : null) || i.scrollTop || t.scrollTop;
        return t.scrollTop = i.scrollTop = a + (0 < a) ? -1 : 1,
        (e = t.scrollTop !== a ? t : i).scrollTop = a,
        e
    }
    var _R = jQuery.fn.revolution
      , _ISM = _R.is_mobile()
    ...
    var checkActions_intern = function(n, r, e) {
        e && jQuery.each(e, function(e, a) {
            ...
            r.fullscreen_esclistener || "exitfullscreen" != a.action && "togglefullscreen" != a.action || (jQuery(document).keyup(function(e) {
            ...
            switch (-1 != jQuery.inArray(a.action, ["toggleslider", "toggle_mute_video", "toggle_global_mute_video", "togglefullscreen"]) && n.data("togglelisteners", !0),
            a.action) {
            case "togglevideo":
            ...
            case "togglelayer":
                jQuery.each(t, function(e, t) {
                    ...
                    null == i && (i = new Array),
                    i.push(n),
                    t.data("layertoggledby", i),
                    t.data("triggered_startstatus", a.layerstatus)
                });
                break;
            ...
            case "toggle_global_mute_video":
                jQuery.each(t, function(e, t) {
                    ...
                    null == i && (i = new Array),
                    i.push(n),
                    t.data("videomutetoggledby", i)
                });
                break;
            case "toggleslider":
                null == r.slidertoggledby && (r.slidertoggledby = new Array),
                r.slidertoggledby.push(n);
                break;
            case "togglefullscreen":
                null == r.fullscreentoggledby && (r.fullscreentoggledby = new Array),
                r.fullscreentoggledby.push(n)
            }
            switch (n.on(a.event, function() {
                if ("click" === a.event && n.hasClass("tp-temporarydisabled"))
                    return !1;
                ...
                if ("stoplayer" == a.action || "togglelayer" == a.action || "startlayer" == a.action) {
                    if (0 < e.length) {
                        var t = e.data();
                        void 0 !== t.clicked_time_stamp && 150 < (new Date).getTime() - t.clicked_time_stamp && (clearTimeout(t.triggerdelayIn),
                        clearTimeout(t.triggerdelayOut)),
                        t.clicked_time_stamp = (new Date).getTime(),
                        "startlayer" == a.action || "togglelayer" == a.action && "in" != e.data("animdirection") ? (t.animdirection = "in",
                        t.triggerstate = "on",
                        _R.toggleState(t.layertoggledby),
                        _R.playAnimationFrame && (clearTimeout(t.triggerdelayIn),
                        ...
                        }, 1e3 * a.delay))) : ("stoplayer" == a.action || "togglelayer" == a.action && "out" != e.data("animdirection")) && (t.animdirection = "out",
                        t.triggered = !0,
                        t.triggerstate = "off",
                        _R.stopVideo && _R.stopVideo(e, r),
                        _R.unToggleState(t.layertoggledby),
                        _R.endMoveCaption && (clearTimeout(t.triggerdelayOut),
                    ...
                    _R.isSafari11() ? actionSwitches(e, r, a, n) : punchgs.TweenLite.delayedCall(a.delay, function() {
      ...
      , actionSwitches = function(tnc, opt, a, _nc) {
        ...
        case "unmutevideo":
            ...
            break;
        case "toggle_mute_video":
            0 < tnc.length && (_R.isVideoMuted(tnc, opt) ? _R.unMuteVideo(tnc, opt) : _R.muteVideo && _R.muteVideo(tnc, opt)),
            _nc.toggleClass("rs-toggle-content-active");
            break;
        case "toggle_global_mute_video":
            !0 === opt.globalmute ? (opt.globalmute = !1,
            null != opt.playingvideos && 0 < opt.playingvideos.length && jQuery.each(opt.playingvideos, function(e, t) {
...
function(e) {
    ...
    jQuery.extend(!0, c, {
        prepareCarousel: function(e, t, i, a) {
            return "stop" !== c.compare_version(n).check && (i = e.carousel.lastdirection = d(i, e.carousel.lastdirection),
            r(e),
            e.carousel.slide_offset_target = s(e),
            void (void 0 !== a ? u(e, i, !1, 0) : null == t ? c.carouselToEvalPosition(e, i) : u(e, i, !1)))
        },
        carouselToEvalPosition: function(e, t) {
            ...
            var a = "center" === i.horizontal_align ? (i.wrapwidth / 2 - i.slide_width / 2 - i.slide_globaloffset) / i.slide_width : (0 - i.slide_globaloffset) / i.slide_width
              ...
              , o = -1 * (Math.ceil(n) - n)
              , l = -1 * (Math.floor(n) - n);
            s = .3 <= r && "left" === t || .7 <= r && "right" === t ? o : r < .3 && "left" === t || r < .7 && "right" === t ? l : s,
        ...
        organiseCarousel: function(s, o, l, e) {
            ...
            for (var d = s.carousel, c = new Array, u = d.slides.length, t = ("right" === d.horizontal_align && s.width,
            0); t < u; t++) {
            ...
            d.slides && jQuery.each(d.slides, function(e, t) {
                ...
                if ((l && Math.abs(n) < h || 0 === n) && (h = Math.abs(n),
                d.focused = e),
                ...
                "on" === d.fadeout)
                    if ("on" === d.vary_fade)
                        a.autoAlpha = 1 - Math.abs(1 / Math.ceil(d.maxVisibleItems / r) * n);
                    else
                    ...
                    a.autoAlpha = Math.abs(n) < Math.ceil(d.maxVisibleItems / r) ? 1 : 0;
                ...
                void 0 !== d.maxRotation && 0 != Math.abs(d.maxRotation) && ("on" === d.vary_rotation ? (a.rotationY = Math.abs(d.maxRotation) - Math.abs((1 - Math.abs(1 / Math.ceil(d.maxVisibleItems / r) * n)) * d.maxRotation),
                a.autoAlpha = 90 < Math.abs(a.rotationY) ? 0 : a.autoAlpha) : a.rotationY = 1 <= n || n <= -1 ? d.maxRotation : Math.abs(n) * d.maxRotation,
            ...
            e && (s.c.find(".next-revslide").removeClass("next-revslide"),
            jQuery(d.slides[d.focused]).addClass("next-revslide"),
            s.c.trigger("revolution.nextslide.waiting")),
            d.wrapwidth,
            d.slide_offset,
            d.maxwidth,
            d.slide_offset,
    ...
    var r = function(e) {
        ...
        var t, i, a = e.carousel, n = c.getHorizontalOffset(e.c, "left"), r = c.getHorizontalOffset(e.c, "right");
        void 0 === a.wrap && ((i = (t = e).carousel).infbackup = i.infinity,
        ...
        0 !== i.maxRotation && ("3D" != t.parallax.type && "3d" != t.parallax.type ? punchgs.TweenLite.set(i.wrap, {
            perspective: 1200,
            transformStyle: "flat"
        ...
        a.wrapwidth = "auto" != e.sliderLayout ? a.wrapwidth > e.c.closest(".tp-simpleresponsive").width() ? e.c.closest(".tp-simpleresponsive").width() : a.wrapwidth : a.wrapwidth > e.ul.width() ? e.ul.width() : a.wrapwidth,
      ...
      , u = function(t, i, a, e) {
        ...
        n.positionanim = punchgs.TweenLite.to(r, e, {
            from: r.to,
            onUpdate: function() {
                n.slide_offset = n.slide_globaloffset + r.from,
                n.slide_offset = c.simp(n.slide_offset, n.maxwidth),
                c.organiseCarousel(t, i, !1, !1)
            },
            onComplete: function() {
                ...
                t.c.find(".next-revslide").removeClass("next-revslide"),
                a && c.callingNewSlide(t.c, e.data("index"))
            },
            ease: s
        })
    }
      ...
      , s = function(e) {
        var t, i, a, n, r, s = 0, o = e.carousel;
        if (void 0 !== o.positionanim && o.positionanim.kill(),
        "none" == o.slide_globaloffset)
            o.slide_globaloffset = s = "center" === o.horizontal_align ? o.wrapwidth / 2 - o.slide_width / 2 : 0;
        else {
            ...
            s = "off" === o.infinity ? d - l : (t = d,
            i = l,
            a = e.slideamount,
            r = i - a - t,
            n = h(n = i - t, a),
            r = h(r, a),
            -(Math.abs(n) > Math.abs(r) ? r : n)),
            s *= o.slide_width
        }
        return s
    }
...
function(e) {
    ...
    jQuery.extend(!0, v, {
        stopKenBurn: function(e) {
            if ("stop" === v.compare_version(y).check)
                return !1;
        ...
        startKenBurn: function(e, t, i) {
            ...
            var a = e.data()
              ...
              , s = (a.owidth,
            a.oheight,
            "carousel" === t.sliderType ? t.carousel.slide_width : t.ul.width())
              , o = t.ul.height();
            if (e.data("kbtl") && e.data("kbtl").kill(),
            i = i || 0,
            0 == e.find(".tp-kbimg").length) {
                var l = n.data("mediafilter");
                l = void 0 === l ? "" : l,
                e.append('<div class="tp-kbimg-wrap ' + l + '" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;"><img class="tp-kbimg" src="' + r + '" style="position:absolute;" width="' + a.owidth + '" height="' + a.oheight + '"></div>'),
            ...
            null != e.data("kbtl") && (e.data("kbtl").kill(),
            e.removeData("kbtl"));
            var d = e.data("kenburn")
              ...
              , u = function(e, t, i) {
                ...
                var d = function(e, t, i, a, n) {
                    ...
                    var l = new Object;
                    return l.start = f(n.start.width, n.start.height, n.start.scale, t, i, s, o),
                    l.end = f(n.start.width, n.start.height, n.end.scale, t, i, s, o),
                    l
                }(i, e, t, 0, o);
                r[0] = parseFloat(r[0]) + d.start.l,
                s[0] = parseFloat(s[0]) + d.end.l,
                r[1] = parseFloat(r[1]) + d.start.t,
                s[1] = parseFloat(s[1]) + d.end.t;
                var c = d.start.r - d.start.l
                  , u = d.start.b - d.start.t
                  , h = d.end.r - d.end.l
                  , p = d.end.b - d.end.t;
                return r[0] = 0 < r[0] ? 0 : c + r[0] < e ? e - c : r[0],
...
function(e) {
    ...
    jQuery.extend(!0, D, {
            ...
            if (!i.frames_added) {
                ...
                void 0 !== i.frames)
                    for (var o = 0; o < i.frames.length; o++)
                        void 0 !== i.frames[o].sfx_effect && 0 <= i.frames[o].sfx_effect.indexOf("block") && (i.frames[o].to = 0 === o ? (i.frames[o].from = "o:0",
                        "o:1") : "o:0",
                        i._sfx = "block"),
                        void 0 === i.frames[0].from && (i.frames[0].from = "o:inherit"),
                        0 === i.frames[0].delay && (i.frames[0].delay = 20),
                        "hover" === i.frames[o].frame ? i.hoverframeindex = o : "frame_999" !== i.frames[o].frame && "frame_out" !== i.frames[o].frame && "last" !== i.frames[o].frame && "end" !== i.frames[o].frame || (i.outframeindex = o),
        ...
        animcompleted: function(e, t) {
            ...
            null != a && "none" != a && (1 == n || "true" == n || "on" == n || "1sttime" == n || r ? (("carousel" !== t.sliderType || "carousel" === t.sliderType && "on" === t.carousel.showLayersAllTime && e.closest("li").hasClass("active-revslide") || "carousel" === t.sliderType && "on" !== t.carousel.showLayersAllTime && e.closest("li").hasClass("active-revslide")) && D.playVideo(e, t),
            D.toggleState(e.data("videotoggledby")),
            (r || "1sttime" == n) && (i.autoplayonlyfirsttime = !1,
            i.autoplay = "off")) : ("no1sttime" == n && (i.datasetautoplay = "on"),
            D.unToggleState(e.data("videotoggledby"))))
        },
        ...
        animateTheCaptions: function(e) {
            if ("stop" === D.compare_version(d).check)
                return !1;
            var h = e.opt
              , t = e.slide
              , n = e.recall
              ...
              , a = t.data("index");
            if (h.layers = h.layers || new Object,
            ...
            h.debugMode) {
                ...
                l.append('<div class="hginfo">Zoom:' + Math.round(100 * h.bw) + "% &nbsp;&nbsp;&nbsp; Device Level:" + h.curWinRange + "&nbsp;&nbsp;&nbsp; Grid Preset:" + h.gridwidth[h.curWinRange] + "x" + h.gridheight[h.curWinRange] + "</div>"),
            ...
            h.layers.static && jQuery.each(h.layers.static, function(e, t) {
                var i = jQuery(this)
                  , a = i.data();
                !0 !== a.hoveredstatus && !0 !== a.inhoveroutanimation ? (D.updateMarkup(this, h),
                D.prepareSingleCaption({
                    caption: i,
                    opt: h,
                    offsetx: o,
                ...
                a.veryfirstststic = !0),
                n && "carousel" === h.sliderType && "on" === h.carousel.showLayersAllTime && D.animcompleted(i, h)) : D.prepareSingleCaption({
                    caption: i,
                    opt: h,
                    offsetx: o,
                    offsety: 0,
            ...
            r || void 0 !== s && (void 0 !== a && jQuery.each(h.timelines[a].layers, function(e, t) {
                var i = t.layer.data();
            ...
            h.timelines.staticlayers && jQuery.each(h.timelines.staticlayers.layers, function(e, t) {
                var i = t.layer.data()
                  ...
                  , c = (i.frames[i.frames.length - 1].delay,
                ...
                i.triggeredtimeline.time(o)) : !0 !== i.hoveredstatus && t.timeline.time(o)),
                "reset" === u && "hidden" === c && (t.timeline.time(0),
                i.animdirection = "out"),
                a ? l ? p === t.lastslide && (t.timeline.play(s),
                i.animdirection = "in") : (d || "in" === i.animdirection || t.timeline.play(r),
                ("visible" == c && "keep" !== u || "keep" === u && !0 === l || "visible" == c && void 0 === l) && (t.timeline.play(r + .01),
                i.animdirection = "in")) : n && l && t.timeline.play("frame_999"))
            })),
        ...
        prepareSingleCaption: function(e) {
            ...
            if ("off" === (void 0 === i.visibility ? "oon" : B(i.visibility, a)[a.forcedWinRange] || B(i.visibility, a) || "ooon") || i._gw < a.hideCaptionAtLimit && "on" == i.captionhidden || i._gw < a.hideAllCaptionAtLimit ? i._pw.addClass("tp-hidden-caption") : i._pw.removeClass("tp-hidden-caption"),
            i.layertype = "html",
            ...
            0 < t.find("img").length) {
                ...
                if ("full-proportional" === d) {
                    ...
                    d = p ? u : !jQuery.isNumeric(d) && 0 < d.indexOf("%") ? d : parseFloat(d),
                    c = f ? h : !jQuery.isNumeric(c) && 0 < c.indexOf("%") ? c : parseFloat(c);
                d = void 0 === d ? 0 : d,
                c = void 0 === c ? 0 : c,
                "off" !== i._responsive ? ("grid" != i._ba && p ? jQuery.isNumeric(d) ? l.css({
                    width: d + "px"
                }) : l.css({
                    width: d
            ...
            if (t.hasClass("tp-videolayer") || t.hasClass("tp-audiolayer") || 0 < t.find("iframe").length || 0 < t.find(v).length) {
                i.layertype = "video",
                D.manageVideoLayer && D.manageVideoLayer(t, a, n, r),
                n || r || (i.videotype,
                D.resetVideo && D.resetVideo(t, a, e.preset));
                var y = i.aspectratio;
                null != y && 1 < y.split(":").length && D.prepareCoveredVideo(a, t),
                l = t.find("iframe") ? t.find("iframe") : l = t.find(v);
                var w = !t.find("iframe")
                  , _ = t.hasClass("coverscreenvideo");
                l.css({
                    display: "block"
                }),
                null == t.data("videowidth") && (t.data("videowidth", l.width()),
                t.data("videoheight", l.height())),
                ...
                var b = X(i.cssobj, a);
                if ("auto" == b.lineHeight && (b.lineHeight = b.fontSize + 4),
                t.hasClass("fullscreenvideo") || _) {
                    e.offsetx = 0,
                    e.offsety = 0,
                    t.data("x", 0),
                    t.data("y", 0);
                ...
                (0 == w && !_ || 1 != i.forcecover && !t.hasClass("fullscreenvideo") && !_) && (l.width(d),
                l.height(c)),
            ...
            "on" == a.fullScreenAlignForce && (R = a.ulw,
            I = a.ulh),
            "none" !== i._lig && null != i._lig && (R = i._lig.width(),
            I = i._lig.height(),
            e.offsetx = 0,
            e.offsety = 0),
        ...
        buildFullTimeLine: function(e) {
            var t, i, a = e.caption, n = a.data(), r = e.opt, s = {}, o = m();
            if (!(t = r.timelines[n._slideid].layers[n._id]).generated || !0 === e.regenerate) {
                ...
                s.svg && (n.idlesvg = g(n.svg_idle, f()),
                punchgs.TweenLite.set(s.svg, n.idlesvg.anim)),
                -1 !== n.hoverframeindex && void 0 !== n.hoverframeindex && !a.hasClass("rs-hover-ready")) {
                    if (a.addClass("rs-hover-ready"),
                    n.hovertimelines = {},
                    n.hoveranim = H(o, n.frames[n.hoverframeindex].to),
                    n.hoveranim = v(n.hoveranim, n.frames[n.hoverframeindex].style),
                    s.svg) {
                        var l = g(n.svg_hover, f());
                        null != n.hoveranim.anim.color && (l.anim.fill = n.hoveranim.anim.color,
                        n.idlesvg.anim.css.fill = s.svg.css("fill")),
                        n.hoversvg = l
                    }
                    a.hover(function(e) {
                        var t = {
                ...
                for (var d = 0; d < n.frames.length; d++)
                    if (d !== n.hoverframeindex) {
                        ...
                        t[n.frames[d].framename = c] = {},
                        t[c].timeline = new punchgs.TimelineLite({
                            align: "normal"
                        });
                        var u = n.frames[d].delay
                          , h = (n.triggered_startstatus,
                        void 0 !== u ? 0 <= jQuery.inArray(u, ["slideenter", "bytrigger", "wait"]) ? u : parseInt(u, 0) / 1e3 : "wait");
                        void 0 !== t.firstslide && "frame_0" === c && (i.addLabel("slide_" + t.firstslide + "_pause", 0),
                        i.addPause("slide_" + t.firstslide + "_pause"),
                        i.addLabel("slide_" + t.firstslide, "+=0.005")),
                        void 0 !== t.lastslide && "frame_999" === c && (i.addLabel("slide_" + t.lastslide + "_pause", "+=0.01"),
                        i.addPause("slide_" + t.lastslide + "_pause"),
                        i.addLabel("slide_" + t.lastslide, "+=0.005")),
                        jQuery.isNumeric(h) ? i.addLabel(c, "+=" + h) : (i.addLabel("pause_" + d, "+=0.01"),
                        i.addPause("pause_" + d),
                        i.addLabel(c, "+=0.01")),
                        i = D.createFrameOnTimeline({
                            caption: e.caption,
                            timeline: i,
                            label: c,
                            frameindex: d,
        ...
        createFrameOnTimeline: function(e) {
            var t = e.caption
              ...
              , f = !1;
            if (h = void 0 === h ? "forward" : h,
            -1 !== i.hoverframeindex && i.hoverframeindex == c && (c -= 1),
            l.content = new punchgs.TimelineLite({
                align: "normal"
            }),
            ...
            void 0 !== i.mySplitText && u && u.match(/chars|words|lines/g) && (o = i.mySplitText[u],
            f = !0);
            var m, v, y = r !== i.outframeindex ? H(F(), i.frames[r].to, void 0, f, o.length - 1) : void 0 !== i.frames[r].to && null === i.frames[r].to.match(/auto:auto/g) ? H(E(), i.frames[r].to, 1 == s.sdir, f, o.length - 1) : H(E(), i.frames[i.inframeindex].from, 0 == s.sdir, f, o.length - 1), w = void 0 !== i.frames[r].from ? H(y, i.frames[i.inframeindex].from, 1 == s.sdir, f, o.length - 1) : void 0, _ = i.frames[r].splitdelay;
            if (0 !== r || e.fromcurrentstate ? v = W(i.frames[r].mask) : m = W(i.frames[r].mask),
            y.anim.ease = void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease,
            void 0 !== w && (w.anim.ease = void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease,
            ...
            void 0 !== y && (y.anim.ease = void 0 === i.frames[r].ease ? punchgs.Power1.easeInOut : i.frames[r].ease,
            ...
            0 !== r || e.fromcurrentstate)
                ...
                if (o != t) {
                    ...
                    n.add(punchgs.TweenLite.set(t, y.anim), a),
                    (y = F()).ease = b.ease,
                    void 0 !== b.filter && (y.anim.filter = b.filter),
                    void 0 !== b["-webkit-filter"] && (y.anim["-webkit-filter"] = b["-webkit-filter"])
                }
                w.anim.visibility = "hidden",
                w.anim.immediateRender = !0,
            ...
            if (0 === r && !e.fromcurrentstate && void 0 !== i._bmask && void 0 !== p && 0 <= p.indexOf("block") || r === i.outframeindex && !e.fromcurrentstate && void 0 !== i._bmask && void 0 !== p && 0 <= p.indexOf("block")) {
                ...
                switch (x = void 0 === _ ? T : _ + T,
                p) {
                case "blocktoleft":
                case "blockfromright":
                    C[0].transformOrigin = "100% 50%",
                    k.transformOrigin = "0% 50%";
                    break;
                case "blockfromtop":
                case "blocktobottom":
                    C = [{
                ...
                C[0].background = i.frames[r].sfxcolor,
                n.add(l.mask.fromTo(i._bmask, T, C[0], C[1], _), a),
                n.add(l.mask.to(i._bmask, T, k, x), a)
            }
            if (f)
                var S = z(o.length - 1, h);
            if (0 !== r || e.fromcurrentstate)
                if ("block" === i._sfx_out && r === i.outframeindex)
                    n.add(l.content.staggerTo(o, .001, {
                        autoAlpha: 0,
                        delay: x
                    }), a),
                    n.add(l.content.staggerTo(o, y.speed / 1e3 / 2 - .001, {
                        x: 0,
                        delay: x
                    }), a + "+=0.001");
                else if (f && void 0 !== S)
                    ...
                    o) {
                        for (var L in R = jQuery.extend({}, y.anim),
                        O.to)
                            R[L] = parseInt(O.to[L].values[O.to[L].index], 0),
                            O.to[L].index = O.to[L].index < O.to[L].len ? O.to[L].index + 1 : 0;
                        void 0 !== i.frames[r].color && (R.color = i.frames[r].color),
                        void 0 !== i.frames[r].bgcolor && (R.backgroundColor = i.frames[r].bgcolor),
                        n.add(l.content.to(o[S[j]], y.speed / 1e3, R, _ * j), a)
                    }
                else
                    void 0 !== i.frames[r].color && (y.anim.color = i.frames[r].color),
                    void 0 !== i.frames[r].bgcolor && (y.anim.backgroundColor = i.frames[r].bgcolor),
                    n.add(l.content.staggerTo(o, y.speed / 1e3, y.anim, _), a);
            else if ("block" === i._sfx_in)
                n.add(l.content.staggerFromTo(o, .05, {
                    x: 0,
                    y: 0,
                    autoAlpha: 0
                }, {
                ...
                for (var j in o) {
                    ...
                    for (var L in O.from)
                        P[L] = parseInt(O.from[L].values[O.from[L].index], 0),
                        O.from[L].index = O.from[L].index < O.from[L].len ? O.from[L].index + 1 : 0;
                    R.ease = P.ease,
                    void 0 !== i.frames[r].color && (P.color = i.frames[r].color,
                    R.color = i.cssobj.styleProps.color),
                    void 0 !== i.frames[r].bgcolor && (P.backgroundColor = i.frames[r].bgcolor,
                    R.backgroundColor = i.cssobj.styleProps["background-color"]),
                    n.add(l.content.fromTo(o[S[j]], w.speed / 1e3, P, R, _ * j), a)
                }
            } else
                void 0 !== i.frames[r].color && (w.anim.color = i.frames[r].color,
                y.anim.color = i.cssobj.styleProps.color),
                void 0 !== i.frames[r].bgcolor && (w.anim.backgroundColor = i.frames[r].bgcolor,
                y.anim.backgroundColor = i.cssobj.styleProps["background-color"]),
            ...
            0 === r && m && !1 !== m && !e.fromcurrentstate || 0 === r && e.ignorefirstframe ? ((v = new Object).anim = new Object,
            v.anim.overwrite = "auto",
            v.anim.ease = y.anim.ease,
            v.anim.x = v.anim.y = 0,
            m && !1 !== m && (m.anim.x = m.anim.x * s.bw || N(m.anim.x, s, i.eow, i.eoh, i.calcy, i.calcx, "horizontal"),
            m.anim.y = m.anim.y * s.bw || N(m.anim.y, s, i.eow, i.eoh, i.calcy, i.calcx, "vertical"),
            m.anim.overflow = "hidden")) : 0 === r && n.add(l.mask.set(i._mw, {
                overflow: "visible"
            }), a),
        ...
        endMoveCaption: function(e) {
            ...
            t.timeline.pause(),
            !0 === i.visibleelement && D.createFrameOnTimeline({
                caption: e.caption,
                timeline: t.outnow,
                label: "outnow",
        ...
        playAnimationFrame: function(e) {
            ...
            var t, i = p(e), a = e.caption.data(), n = 0;
        ...
        removeTheCaptions: function(e, i) {
            ...
            a && jQuery.each(a, function(e) {
                ...
                D.stopVideo && D.stopVideo(t, i)) : (r(t),
    ...
    var I = function(e, t, i, a, n, r, s, o, l) {
        ...
        "enterstage" === d.eventtype && (a.animdirection = "in",
        a.visibleelement = !0,
        D.toggleState(a.layertoggledby)),
        "none" !== t.dchildren && void 0 !== t.dchildren && 0 < t.dchildren.length)
            if (0 === e)
                ...
                for (c = 0; c < t.dchildren.length; c++)
                    D.endMoveCaption({
      ...
      , A = function(e, t, i, a, n, r, s, o, l, d) {
        ...
        a.current_timeline_time = n.time(),
        o && (a.static_layer_timeline_time = a.current_timeline_time),
        void 0 !== a.hoveranim && !1 === a._gsTransformTo && (a._gsTransformTo = s,
      ...
      , Q = function(e, t, i, a, n, r, s, o, l) {
        ...
        "leftstage" === d.eventtype && (n.active = !1,
        punchgs.TweenLite.set(a, {
            visibility: "hidden",
            overwrite: "auto"
        }),
        ...
        "video" === n._nctype && D.resetVideo && setTimeout(function() {
            D.resetVideo(o, l)
        }, 100)),
        n.current_frame = e,
      ...
      , c = function(e, t, i, a, n) {
        ...
        if (1 < e.split("{").length) {
            ...
            void 0 !== i && void 0 !== a) {
                parseInt(Math.random() * (s - r), 0),
                parseInt(r, 0);
                for (var o = 0; o < a; o++)
                    e = e + "|" + (parseInt(Math.random() * (s - r), 0) + parseInt(r, 0)) + n;
                e += "]"
            } else
                e = Math.random() * (s - r) + r
        }
      ...
      , N = function(e, t, i, a, n, r, s) {
        ...
        "horizontal" == s ? e = (i + 2) * parseInt(e, 0) / 100 : "vertical" == s && (e = (a + 2) * parseInt(e, 0) / 100)) : e = "top" === (e = "left" === (e = "layer_top" === (e = "layer_left" === e ? 0 - i : "layer_right" === e ? i : e) ? 0 - a : "layer_bottom" === e ? a : e) || "stage_left" === e ? 0 - i - r : "right" === e || "stage_right" === e ? t.conw - r : "center" === e || "stage_center" === e ? t.conw / 2 - i / 2 - r : e) || "stage_top" === e ? 0 - a - n : "bottom" === e || "stage_bottom" === e ? t.conh - n : "middle" === e || "stage_middle" === e ? t.conh / 2 - a / 2 - n : e,
        e
    }
      , H = function(e, t, r, s, o) {
        var l = new Object;
        if (l = jQuery.extend(!0, {}, l, e),
        void 0 === t)
            return l;
        var i = t.split(";")
          , d = "";
    ...
    function V(e, t, i, a, n, r, s) {
        var o = e.find(t);
        o.css("borderWidth", r + "px"),
        o.css(i, 0 - r + "px"),
        o.css(a, "0px solid transparent"),
        o.css(n, s)
    }
    var v = function(a, e) {
        if (void 0 === e)
      ...
      , w = function(e, t) {
        var i, a, n, r = e.data();
        r._cbgc_man && 0 < r._cbgc_man.length && (jQuery.isArray(r.cssobj.marginLeft) ? (r.cssobj.marginLeft[t.curWinRange],
        t.bw,
        i = r.cssobj.marginTop[t.curWinRange] * t.bh,
        a = r.cssobj.marginBottom[t.curWinRange] * t.bh,
        r.cssobj.marginRight[t.curWinRange]) : (r.cssobj.marginLeft,
        t.bw,
      ...
      , u = function(e, t) {
        ...
        if (e.hasClass("rs-rotate") && null == i._loop_timeline && (i._loop_timeline = new punchgs.TimelineLite,
        ...
        if (e.hasClass("rs-wave") && null == i._loop_timeline) {
            ...
            var f = null == e.data("angle") ? 10 : parseInt(e.data("angle"), 0)
              ...
              , m = (r = null == e.data("speed") ? -20 : e.data("speed"),
            (s = null == e.data("origin") ? "50% 50%" : e.data("origin")).split(" "))
              , v = new Object;
            1 <= m.length ? (v.x = m[0],
            v.y = m[1]) : (v.x = "50%",
            v.y = "50%"),
...
function(e) {
    ...
    jQuery.extend(!0, P, {
        ...
        resizeThumbsTabs: function(e, t) {
            if (e.navigation && e.navigation.tabs.enable || e.navigation && e.navigation.thumbnails.enable) {
                ...
                if (a.pause(),
                i = 1 < i ? 1 : i < 0 ? 0 : i,
                v(n) && (t || n.width > n.min_width) && l(i, a, e.c, n, e.slideamount, "tab"),
                v(r) && (t || r.width > r.min_width) && l(i, a, e.c, r, e.slideamount, "thumb"),
                v(s) && t) {
        ...
        manageNavigation: function(e) {
            ...
            v(e.navigation.bullets) && ("fullscreen" != e.sliderLayout && "fullwidth" != e.sliderLayout && (e.navigation.bullets.h_offset_old = void 0 === e.navigation.bullets.h_offset_old ? e.navigation.bullets.h_offset : e.navigation.bullets.h_offset_old,
            ...
            v(e.navigation.arrows) && ("fullscreen" != e.sliderLayout && "fullwidth" != e.sliderLayout && (e.navigation.arrows.left.h_offset_old = void 0 === e.navigation.arrows.left.h_offset_old ? e.navigation.arrows.left.h_offset : e.navigation.arrows.left.h_offset_old,
        ...
        createNavigation: function(s, o) {
            if ("stop" === P.compare_version(t).check)
                return !1;
            var l = s.parent()
            ...
            s.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function() {
                ...
                l.find(".tp-thumb, .tp-tab").each(function() {
                    var e = jQuery(this);
                    e.data("liref") === i ? (e.addClass("selected"),
                    e.hasClass("tp-tab") ? p(l.find(".tp-tabs"), u) : p(l.find(".tp-thumbs"), c)) : e.removeClass("selected")
                });
                var a = 0
                  , n = !1;
                ...
                if (!0 === d.enable) {
                    ...
                    d.right.j.html(r),
                    d.rtl ? (punchgs.TweenLite.set(d.left.j.find(".tp-arr-imgholder"), {
            ...
            l.on("mouseenter mousemove", function() {
                l.hasClass("tp-mouseover") || (l.addClass("tp-mouseover"),
                ...
                R && (l.removeClass("tp-mouseover"),
                y(s, o)))
            }),
            l.on("mouseleave", function() {
                l.removeClass("tp-mouseover"),
                y(s, o)
            }),
    ...
    var p = function(e, t) {
        ...
        e.hasClass("tp-thumbs") ? ".tp-thumb-mask" : ".tp-tab-mask")
          ...
          , m = s.data("offset");
        2 < u && (g = p - (m + l) <= 0 ? p - (m + l) < 0 - l ? m : g + l : g,
        g = p - l + m + d < l && p + (Math.round(u) - 2) * l < m ? p + (Math.round(u) - 2) * l : g),
        g = g < 0 - (f - h) ? 0 - (f - h) : 0 < g ? 0 : g,
        "vertical" !== o && r.width() >= s.width() && (g = 0),
        "vertical" === o && r.height() >= s.height() && (g = 0),
        e.hasClass("dragged") || ("vertical" === o ? s.data("tmmove", punchgs.TweenLite.to(s, .5, {
            top: g + "px",
            ease: punchgs.Power3.easeInOut
      ...
      , l = function(e, i, t, a, n, r) {
        ...
        i.add(punchgs.TweenLite.set(s, p)),
        i.add(punchgs.TweenLite.set(o, {
            width: u + "px",
            height: h + "px"
        })),
      ...
      , i = function(t, i) {
        "on" === i.navigation.keyboardNavigation && jQuery(document).keydown(function(e) {
            ("horizontal" == i.navigation.keyboard_direction && 39 == e.keyCode || "vertical" == i.navigation.keyboard_direction && 40 == e.keyCode) && (i.sc_indicator = "arrow",
            i.sc_indicator_dir = 0,
            P.callingNewSlide(t, 1)),
            ("horizontal" == i.navigation.keyboard_direction && 37 == e.keyCode || "vertical" == i.navigation.keyboard_direction && 38 == e.keyCode) && (i.sc_indicator = "arrow",
      ...
      , f = function(f, g) {
        if ("on" === g.navigation.mouseScrollNavigation || "carousel" === g.navigation.mouseScrollNavigation) {
            g.isIEEleven = !!navigator.userAgent.match(/Trident.*rv\:11\./),
            g.isSafari = !!navigator.userAgent.match(/safari/i),
            g.ischrome = !!navigator.userAgent.match(/chrome/i);
            ...
            f.on("mousewheel DOMMouseScroll", function(e) {
                var t, i, a, n, r, s = (t = e.originalEvent,
                r = n = a = i = 0,
                ...
                "axis"in t && t.axis === t.HORIZONTAL_AXIS && (i = a,
                a = 0),
                n = 1 * i,
                r = 1 * a,
                "deltaY"in t && (r = t.deltaY),
                "deltaX"in t && (n = t.deltaX),
                (n || r) && t.deltaMode && (t.deltaMode,
                n *= 1,
                r *= 1),
                n && !i && (i = n < 1 ? -1 : 1),
                r && !a && (a = r < 1 ? -1 : 1),
                (300 < (r = navigator.userAgent.match(/mozilla/i) ? 10 * r : r) || r < -300) && (r /= 10),
                {
                    ...
                    pixelX: n,
                    pixelY: r
                }), o = f.find(".tp-revslider-slidesli.active-revslide").index(), l = f.find(".tp-revslider-slidesli.processing-revslide").index(), d = -1 != o && 0 == o || -1 != l && 0 == l, c = -1 != o && o == g.slideamount - 1 || 1 != l && l == g.slideamount - 1, u = !0;
                "carousel" == g.navigation.mouseScrollNavigation && (d = c = !1),
                -1 == l ? s.pixelY < m ? (d || (g.sc_indicator = "arrow",
                "reverse" !== g.navigation.mouseScrollReverse && (g.sc_indicator_dir = 1,
                P.callingNewSlide(f, -1)),
                u = !1),
                c || (g.sc_indicator = "arrow",
                "reverse" === g.navigation.mouseScrollReverse && (g.sc_indicator_dir = 0,
                P.callingNewSlide(f, 1)),
                u = !1)) : v < s.pixelY && (c || (g.sc_indicator = "arrow",
                "reverse" !== g.navigation.mouseScrollReverse && (g.sc_indicator_dir = 0,
                P.callingNewSlide(f, 1)),
                u = !1),
                d || (g.sc_indicator = "arrow",
                "reverse" === g.navigation.mouseScrollReverse && (g.sc_indicator_dir = 1,
                P.callingNewSlide(f, -1)),
                u = !1)) : u = !1;
                var h = g.c.offset().top - jQuery("body").scrollTop()
                  , p = h + g.c.height();
                return "carousel" != g.navigation.mouseScrollNavigation ? ("reverse" !== g.navigation.mouseScrollReverse && (0 < h && 0 < s.pixelY || p < jQuery(window).height() && s.pixelY < 0) && (u = !0),
                "reverse" === g.navigation.mouseScrollReverse && (h < 0 && s.pixelY < 0 || p > jQuery(window).height() && 0 < s.pixelY) && (u = !0)) : u = !1,
                0 == u ? (e.preventDefault(e),
                !1) : void 0
            })
        }
    }
        ...
        t.swipetp({
            ...
            swipeStatus: function(e, t, i, a, n, r, s) {
                ...
                if ("carousel" === j.sliderType && (("move" === t || "end" === t || "cancel" == t) && j.dragStartedOverSlider && !j.dragStartedOverThumbs && !j.dragStartedOverTabs || "start" === t && 0 < o && 0 === l && 0 === d)) {
                    if (R && ("up" === i || "down" === i))
                        return;
                    switch (j.dragStartedOverSlider = !0,
                    a = i && i.match(/left|up/g) ? Math.round(-1 * a) : a = Math.round(1 * a),
                    t) {
                    case "start":
                        void 0 !== L.positionanim && (L.positionanim.kill(),
                        L.slide_globaloffset = "off" === L.infinity ? L.slide_offset : P.simp(L.slide_offset, L.maxwidth)),
                        L.overpull = "none",
                        L.wrap.addClass("dragged");
                        break;
                    case "move":
                        if (j.c.find(".tp-withaction").addClass("tp-temporarydisabled"),
                        ...
                        "off" === L.infinity) {
                            ...
                            "none" !== L.overpull && 0 !== L.overpull || !(u < 0 || u > j.slideamount - 1) ? 0 <= u && u <= j.slideamount - 1 && (0 <= u && a > L.overpull || u <= j.slideamount - 1 && a < L.overpull) && (L.overpull = 0) : L.overpull = a,
                            L.slide_offset = u < 0 ? L.slide_offset + (L.overpull - a) / 1.1 + Math.sqrt(Math.abs((L.overpull - a) / 1.1)) : u > j.slideamount - 1 ? L.slide_offset + (L.overpull - a) / 1.1 - Math.sqrt(Math.abs((L.overpull - a) / 1.1)) : L.slide_offset
                        }
                    ...
                    if (("move" !== t && "end" !== t && "cancel" != t || j.dragStartedOverSlider || !j.dragStartedOverThumbs && !j.dragStartedOverTabs) && !("start" === t && 0 < o && (0 < l || 0 < d))) {
                        if ("end" == t && !c) {
                            if (j.sc_indicator = "arrow",
                            "horizontal" == O && "left" == i || "vertical" == O && "up" == i)
                                return j.sc_indicator_dir = 0,
                                P.callingNewSlide(j.c, 1),
                                !1;
                            if ("horizontal" == O && "right" == i || "vertical" == O && "down" == i)
                                return j.sc_indicator_dir = 1,
                                P.callingNewSlide(j.c, -1),
                                !1
                        }
                        return j.dragStartedOverSlider = !1,
                        j.dragStartedOverThumbs = !1,
                        !(j.dragStartedOverTabs = !1)
                    }
                    0 < l && (j.dragStartedOverThumbs = !0),
                    0 < d && (j.dragStartedOverTabs = !0);
                    ...
                    switch (t) {
                    case "start":
                        S.parent().find(h).addClass("dragged"),
                        T = "vertical" === w ? y.position().top : y.position().left,
                        y.data("offset", T),
                    ...
                    case "move":
                        ...
                        "vertical" === w ? punchgs.TweenLite.set(y, {
                            top: C + "px"
                    ...
                    case "cancel":
                        if (c)
                            ...
                            C = 0 < (C = "vertical" === w ? C < 0 - (y.height() - v.height()) ? 0 - (y.height() - v.height()) : C : C < 0 - (y.width() - v.width()) ? 0 - (y.width() - v.width()) : C) ? 0 : C,
                            "vertical" === w ? punchgs.TweenLite.to(y, .5, {
                                top: C + "px",
      ...
      , m = function(e) {
        e.hide_delay = jQuery.isNumeric(parseInt(e.hide_delay, 0)) ? e.hide_delay / 1e3 : .2,
        e.hide_delay_mobile = jQuery.isNumeric(parseInt(e.hide_delay_mobile, 0)) ? e.hide_delay_mobile / 1e3 : .2
    }
      , v = function(e) {
        return e && e.enable
    }
      ...
      , h = function(e, t, i) {
        var a = e.outerHeight(!0)
          , n = (e.outerWidth(!0),
        null == t.opt ? 0 : 0 == i.conh ? i.height : i.conh)
      ...
      , T = function(e, t, i) {
        ...
        if (h(e, t, i),
        b(e, t, i),
        "outer-left" !== t.position || "fullwidth" != t.sliderLayout && "fullscreen" != t.sliderLayout ? "outer-right" !== t.position || "fullwidth" != t.sliderLayout && "fullscreen" != t.sliderLayout || punchgs.TweenLite.set(e, {
        ...
        e.hasClass("tp-thumbs") || e.hasClass("tp-tabs")) {
            ...
            !0 === t.span && "vertical" === t.direction ? (punchgs.TweenLite.set(e, {
                maxHeight: c + u + (r - 2 * s) + "px",
                height: c + u + (r - 2 * s) + "px",
                top: 0 - c,
                y: 0
      ...
      , x = function(e, t, i, a) {
        ...
        e.append('<div class="tp-bullets ' + t.style + " " + t.direction + '"></div>'));
      ...
      , d = function(e) {
        ...
        e.top_outer = t.hasClass("tp-forcenotvisible") ? 0 : t.outerHeight() || 0,
        e.bottom_outer = i.hasClass("tp-forcenotvisible") ? 0 : i.outerHeight() || 0
    }
      , s = function(e, t, i, a) {
...
function(e) {
    ...
    jQuery.extend(!0, x, {
        checkForParallax: function(v, y) {
            function e(e) {
                if ("3D" == w.type || "3d" == w.type) {
                    ...
                    "carousel" == y.sliderType && ("on" == w.ddd_shadow && t.addClass("dddwrappershadow"),
                    punchgs.TweenLite.set(t, {
            ...
            if ("stop" === x.compare_version(a).check)
                return !1;
            var w = y.parallax;
            if (!w.done) {
                if (w.done = !0,
                T && "on" == w.disable_onmobile)
                    return !1;
                ...
                "carousel" != y.sliderType && "on" == w.ddd_shadow && (y.c.prepend('<div class="dddwrappershadow"></div>'),
                ...
                y.c.find(".tp-revslider-slidesli .slotholder, .tp-revslider-slidesli .rs-background-video-layer").each(function() {
                    ...
                    void 0 !== (t = "on" == t ? 1 : t) && "off" !== t && (w.bgcontainers.push(e),
                    w.bgcontainer_depths.push(y.parallax.levels[parseInt(t, 0) - 1] / 100))
                });
                for (var t = 1; t <= w.levels.length; t++)
                    y.c.find(".rs-parallaxlevel-" + t).each(function() {
                        var e = jQuery(this).closest(".tp-parallax-wrap");
                        e.data("parallaxlevel", w.levels[t - 1]),
                        e.addClass("tp-parallax-container"),
                        w.pcontainers.push(e),
                        w.pcontainer_depths.push(w.levels[t - 1])
                    });
                ...
                v.on("mousemove.hoverdir, mouseleave.hoverdir, trigger3dpath", function(d, e) {
                    ...
                    if ("enterpoint" == w.origo) {
                        var i = v.offset().top
                          , a = v.offset().left;
                        null == t.data("enterx") && t.data("enterx", d.pageX - a),
                        null == t.data("entery") && t.data("entery", d.pageY - i);
                        ...
                        i = v.offset().top,
                        a = v.offset().left,
                        c = y.conw / 2 - (d.pageX - a),
                        u = y.conh / 2 - (d.pageY - i),
                        h = w.speed / 1e3 || 3;
                    "mouseleave" == d.type && (c = w.ddd_lasth || 0,
                    u = w.ddd_lastv || 0,
                    h = 1.5);
                    ...
                    if ("3D" == w.type || "3d" == w.type) {
                        ...
                        y.c.find(m).each(function() {
                            var e = jQuery(this)
                              ...
                              , o = 0
                              , l = !1;
                            e.hasClass("dddwrapper-layer") && (o = w.ddd_z_correction || 65,
                            l = !0),
                            e.hasClass("dddwrapper-layer") && (a = i = 0),
                            s.hasClass("active-revslide") || "carousel" != y.sliderType ? "on" != w.ddd_bgfreeze || l ? punchgs.TweenLite.to(e, h, {
                                rotationX: r,
                                rotationY: -n,
                                x: i,
                                z: o,
                ...
                i.on) {
                    if ("on" === i.on_slidebg)
                        for (t = 0; t < y.allslotholder.length; t++)
                            i.bgs.push(y.allslotholder[t]);
        ...
        scrollTicker: function(t, e) {
            1 != t.scrollTicker && (t.scrollTicker = !0,
            T ? (punchgs.TweenLite.ticker.fps(150),
        ...
        scrollHandling: function(e, t, i) {
            ...
            if (e.scrollproc = s,
            x.callBackHandling && x.callBackHandling(e, "parallax", "start"),
            n.enable) {
                var o = 1 - Math.abs(s);
                o = o < 0 ? 0 : o,
                jQuery.isNumeric(n.visible_area) || -1 !== n.visible_area.indexOf("%") && (n.visible_area = parseInt(n.visible_area) / 100),
                1 - n.visible_area <= o ? e.inviewport || (e.inviewport = !0,
                x.enterInViewPort(e)) : e.inviewport && (e.inviewport = !1,
                x.leaveViewPort(e))
            }
            if (T && "on" == r.disable_onmobile)
                return !1;
            if ("3d" != r.type && "3D" != r.type) {
                if (("scroll" == r.type || "scroll+mouse" == r.type || "mouse+scroll" == r.type) && r.pcontainers)
                    for (var l = 0; l < r.pcontainers.length; l++)
                        if (0 < r.pcontainers[l].length) {
                            ...
                            d.data("parallaxoffset", u),
                            punchgs.TweenLite.to(d, h, {
                                overwrite: "auto",
                                force3D: "auto",
                                y: u
                            })
                ...
                if (r.bgcontainers)
                    for (l = 0; l < r.bgcontainers.length; l++) {
                        ...
                        u = s * (-r.bgcontainer_depths[l] * e.conh) || 0,
                        h = void 0 !== i ? i : r.speedbg / 1e3 || 0;
            ...
            if (f.on && ("on" !== f.disable_on_mobile || !T)) {
                ...
                !1 !== f.layers) {
                    ...
                    if ("top" == f.direction && 0 <= s && (m = 1),
                    "bottom" == f.direction && s <= 0 && (m = 1),
                    m = 1 < m ? 1 : m < 0 ? 0 : m,
                    "on" === f.fade && (v.opacity = m),
                    "on" === f.scale) {
                        var y = m;
                        v.scale = 1 - y + 1
                    }
                    if ("on" === f.blur) {
                        var w = (1 - m) * f.maxblur;
                        v["-webkit-filter"] = "blur(" + w + "px)",
                        v.filter = "blur(" + w + "px)"
                    }
                    if ("on" === f.grayscale) {
                        var _ = "grayscale(" + 100 * (1 - m) + "%)";
                        v["-webkit-filter"] = void 0 === v["-webkit-filter"] ? _ : v["-webkit-filter"] + " " + _,
                        v.filter = void 0 === v.filter ? _ : v.filter + " " + _
                    }
                    punchgs.TweenLite.set(f.layers, v)
                }
                if (!1 !== f.bgs) {
                    m = 1 - g * f.multiplicator,
                    v = {
                        backfaceVisibility: "hidden",
                        force3D: "true"
                    };
...
function(e) {
    ...
    var he = function(e, t, i, a) {
        ...
        null != r.data("currotate") && (l = r.data("currotate")),
        null != r.data("curscale") && "box" == a ? o = 100 * r.data("curscale") : null != r.data("curscale") && (o = r.data("curscale")),
        T.slotSize(r, t);
        var d = r.attr("src")
          , c = r.data("bgcolor")
          , u = t.width
          , h = t.height
          , p = r.data("fxof");
        void 0 === c && (c = r.css("backgroundColor")),
        "on" == t.autoHeight && (h = t.c.height()),
        null == p && (p = 0);
        var f = 0
          , g = r.data("bgfit")
          , m = r.data("bgrepeat")
        ...
        null == g && (g = "cover"),
        null == m && (m = "no-repeat"),
        null == v && (v = "center center");
        var y;
        switch (y = void 0 !== c && 0 <= c.indexOf("gradient") ? "background:" + c : "background-color:" + c + ";background-image:url(" + d + ");background-repeat:" + m + ";background-size:" + g + ";background-position:" + v,
        a) {
        case "box":
            for (var w = 0, _ = 0, b = 0; b < t.slots; b++) {
                for (var x = _ = 0; x < t.slots; x++)
                    n.append('<div class="slot" style="position:absolute;top:' + (0 + _) + "px;left:" + (p + w) + "px;width:" + t.slotw + "px;height:" + t.sloth + 'px;overflow:hidden;"><div class="slotslide ' + s + '" data-x="' + w + '" data-y="' + _ + '" style="position:absolute;top:0px;left:0px;width:' + t.slotw + "px;height:" + t.sloth + 'px;overflow:hidden;"><div style="position:absolute;top:' + (0 - _) + "px;left:" + (0 - w) + "px;width:" + u + "px;height:" + h + "px;" + y + ';"></div></div></div>'),
                    _ += t.sloth,
                    null != o && null != l && punchgs.TweenLite.set(n.find(".slot").last(), {
                        rotationZ: l
                    });
                w += t.slotw
            }
      ...
      , d = function(a, e, x, t, i, n, r, s) {
        ...
        var c = function(e, i, t, a) {
            ...
            "random" == i && (i = Math.round(Math.random() * w.length - 1),
            w.length - 1 < i && (i = w.length - 1)),
            "random-static" == i && (i = Math.round(Math.random() * p.length - 1),
            p.length - 1 < i && (i = p.length - 1),
            i = p[i]),
            "random-premium" == i && (i = Math.round(Math.random() * f.length - 1),
            f.length - 1 < i && (i = f.length - 1),
            i = f[i]),
        ...
        11 != a && (null != u[7] && he(r, o, u[7], u[5]),
        null != u[6] && he(n, o, u[6], u[5])),
        ...
        var g, m = pe(t.data("easein"), p), v = pe(t.data("easeout"), p);
        if (m = "default" === m ? u[9] || punchgs.Power2.easeInOut : m || u[9] || punchgs.Power2.easeInOut,
        v = "default" === v ? u[10] || punchgs.Power2.easeInOut : v || u[10] || punchgs.Power2.easeInOut,
        0 == a) {
            ...
            n.find(".slotslide").each(function(e) {
                var t = jQuery(this);
                (w += 1) == y && (w = 0),
                s.add(punchgs.TweenLite.from(t, f / 600, {
                    opacity: 0,
                    top: 0 - o.sloth,
                    left: 0 - o.slotw,
                    rotation: o.rotate,
        ...
        1 == a && n.find(".slotslide").each(function(e) {
            ...
            g < i + a && (g = a + a),
            s.add(punchgs.TweenLite.from(t, i / 1e3, {
                autoAlpha: 0,
                force3D: "auto",
                rotation: o.rotate,
                ease: m
        ...
        if (3 == a && (_ = new punchgs.TimelineLite,
        r.find(".slotslide").each(function() {
            var e = jQuery(this);
            _.add(punchgs.TweenLite.to(e, f / 1e3, {
                top: o.sloth,
        ...
        4 == a || 5 == a) {
            ...
            r.find(".slotslide").each(function(e) {
                ...
                _.add(punchgs.TweenLite.to(t, 3 * b, {
                    transformPerspective: 600,
                    force3D: "auto",
                    top: 0 + o.height,
                    opacity: .5,
            ...
            n.find(".slotslide").each(function(e) {
                var t = jQuery(this)
                  , i = e * b / o.slots;
                5 == a && (i = (o.slots - e - 1) * b / o.slots / 1.5),
                _.add(punchgs.TweenLite.from(t, 3 * b, {
                    top: 0 - o.height,
                    opacity: .5,
                    rotation: o.rotate,
                    force3D: "auto",
        ...
        if (31 == a || 32 == a || 33 == a || 34 == a) {
            ...
            s.add(punchgs.TweenLite.fromTo(r, F - .2 * F, {
                y: 0,
                x: 0
            }, {
                y: ty,
            ...
            s.add(punchgs.TweenLite.fromTo(n, F, {
                y: fy,
                x: fx
            }, {
                y: "0%",
            ...
            function(e, u, h, t, p) {
                ...
                for (var a = 0; a < 6; a++)
                    i.parent().clone(!1).appendTo(nextsh);
                e.find(".slot-circle-wrapper").each(function(e) {
                    if (e < 6) {
                        var t = jQuery(this)
                          ...
                          , c = u;
                        mtl.add(punchgs.TweenLite.fromTo(t, c, s, o), 0),
                        mtl.add(punchgs.TweenLite.fromTo(i, c, l, d), 0),
                        mtl.add(punchgs.TweenLite.fromTo(t, .001, {
                            autoAlpha: 0
                        }, {
                            autoAlpha: 1
                        }), 0)
        ...
        if (11 == a) {
            ...
            case 1:
                ...
                s.add(punchgs.TweenLite.fromTo(r, f / 1e3, {
                    autoAlpha: 1
                }, {
                    autoAlpha: 0,
                    force3D: "auto",
            ...
            case 4:
                ...
                s.add(punchgs.TweenLite.to(r, f / 2e3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    ease: m
                }), 0),
                s.add(punchgs.TweenLite.fromTo(n, f / 2e3, {
                    autoAlpha: 0
                }, {
                    autoAlpha: 1,
                    force3D: "auto",
            ...
            case 12:
                ...
                0 <= jQuery.inArray(h, [6, 8, 10]) && s.add(punchgs.TweenLite.fromTo(r, f / 1e3, {
                    autoAlpha: 1,
                    filter: H,
                    "-webkit-filter": H
                }, {
        ...
        s.add(punchgs.TweenLite.to(r, f / 1e3, {
            autoAlpha: 0,
            force3D: "auto",
            ease: m
        }), 0),
        ...
        12 == a || 13 == a || 14 == a || 15 == a) {
            ...
            var W = o.width
              ...
              , Z = f / 1e3
              , J = Z;
            "fullwidth" != o.sliderLayout && "fullscreen" != o.sliderLayout || (W = V.width(),
            B = V.height()),
            ...
            s.add(punchgs.TweenLite.set(t, {
                zIndex: 20
            }), 0),
            8 == h ? (s.add(punchgs.TweenLite.set(i, {
                zIndex: 20
            }), 0),
            s.add(punchgs.TweenLite.set(t, {
                zIndex: 15
            }), 0),
            s.add(punchgs.TweenLite.set($, {
                left: 0,
                top: 0,
                scale: 1,
                opacity: 1,
        ...
        if (16 == a) {
            ...
            s.add(punchgs.TweenLite.fromTo(i.find(".tp-half-one"), f / 800, {
                width: W,
                height: B / 2,
                position: "absolute",
                top: "0px",
            ...
            s.add(punchgs.TweenLite.fromTo(i.find(".tp-half-two"), f / 800, {
                width: W,
                height: B,
                overflow: "hidden",
                position: "absolute",
            ...
            _.add(punchgs.TweenLite.set(n.find(".defaultimg"), {
                autoAlpha: 1
            }), 0),
            null != i.html() && s.add(punchgs.TweenLite.fromTo(t, (f - 200) / 1e3, {
                scale: oe,
                x: o.width / 4 * ae,
                y: B / 4 * ne,
                rotation: ie,
        ...
        19 == a || 22 == a) {
            ...
            n.find(".slotslide").each(function(e) {
                ...
                _.add(punchgs.TweenLite.to(t, .1, {
                    autoAlpha: 1,
                    delay: 50 * e / 1e3
                }), 0),
                s.add(_)
        ...
        if (21 == a || 25 == a) {
            ...
            ce = -o.width;
            var ue = -le;
            1 == d ? 25 == a ? (de = "center top 0",
            le = o.rotate) : (de = "left center 0",
            ue = o.rotate) : (ce = o.width,
            le = -90,
            25 == a ? (de = "center bottom 0",
            ue = -le,
            le = o.rotate) : (de = "right center 0",
            ue = o.rotate)),
            n.find(".slotslide").each(function(e) {
                var t = jQuery(this)
                  , i = f / 1.5 / 3;
        ...
        le = -90,
        (q = 1) == d && (le = 90),
        23 == a ? (de = "center center -" + o.width / 2,
        q = 0) : de = "center center " + o.width / 2,
        punchgs.TweenLite.set(x, {
            transformStyle: "preserve-3d",
            backfaceVisibility: "hidden",
            perspective: 2500
        ...
        r.find(".slotslide").each(function(e) {
            ...
            23 == a && s.add(punchgs.TweenLite.fromTo(t, f / 2e3, {
                autoAlpha: 1
            }, {
                autoAlpha: 0,
...
function(e) {
    ...
    jQuery.extend(!0, L, {
        preLoadAudio: function(e, i) {
            if ("stop" === L.compare_version(P).check)
                return !1;
            e.find(".tp-audiolayer").each(function() {
                ...
                "auto" != t.pre && "canplaythrough" != t.pre && "canplay" != t.pre && "progress" != t.pre || (void 0 === i.audioqueue && (i.audioqueue = []),
                i.audioqueue.push(t),
                L.manageVideoLayer(e, i)))
            })
        },
            ...
            case "vimeo":
                ...
                try {
                    if ("on" == n.forcerewind) {
                        ...
                        r = -1 == l,
                        s = 1 === n.bgvideo || 0 < e.find(".tp-videoposter").length,
                        (0 !== (l = -1 == l ? 0 : l) && !r || s) && o.pause().then(function() {
                            o.setCurrentTime(l)
                        })
                    }
                } catch (e) {}
        ...
        stopVideo: function(e, t) {
            ...
            case "youtube":
                try {
                    var a = i.player;
                    if (2 === a.getPlayerState() || 5 === a.getPlayerState())
                        return;
                    a.pauseVideo(),
        ...
        playVideo: function(i, a) {
            ...
            case "youtube":
                if (0 == i.find("iframe").length)
                    ...
                    1 == i.data("nextslideatend-triggered") && (n = -1,
                    i.data("nextslideatend-triggered", 0)),
                    -1 != t && n < t && e.player.seekTo(t),
                    !0 !== e.youtubepausecalled && e.player.playVideo()
                } else
                    i.data("videoplaywait", setTimeout(function() {
            ...
            case "vimeo":
                if (0 == i.find("iframe").length)
                    ...
                    i.data("vimeoplayer") ? r = i.data("vimeoplayer") : (r = new Vimeo.Player(s),
                    i.data("vimeoplayer", r)),
                    r.getPaused() ? setTimeout(function() {
                        var e = R(i.data("videostartat"))
                          , t = i.data("currenttime");
                        t || (t = 0),
                        1 == i.data("nextslideatend-triggered") && (t = -1,
                        i.data("nextslideatend-triggered", 0)),
                        -1 != e && t < e && r.setCurrentTime(e),
                        r.play()
            ...
            case "html5":
                ...
                1 != l.parent().data("metaloaded") ? I(d, "loadedmetadata", function(e) {
                    ...
                    -1 != t && i < t && (d.currentTime = t)
                }(i)) : (d.play(),
                t = R(i.data("videostartat")),
                n = d.currentTime,
                1 == i.data("nextslideatend-triggered") && (n = -1,
                i.data("nextslideatend-triggered", 0)),
                -1 != t && n < t && (d.currentTime = t))
            }
        },
        ...
        manageVideoLayer: function(a, n, e, t) {
            ...
            switch (g = !0 === i.nextslideatend ? "" : g,
            i.videotype = m,
            y) {
            case "html5":
                "controls" != p && (p = ""),
                v = "video",
                "html5" == i.audio && (v = "audio",
                ...
                "video" === v ? (null != c && "firefox" == L.get_browser().toLowerCase() && (_ = _ + '<source src="' + c + '" type="video/webm" />'),
                null != d && (_ = _ + '<source src="' + d + '" type="video/mp4" />'),
                null != u && (_ = _ + '<source src="' + u + '" type="video/ogg" />')) : "audio" === v && (null != d && (_ = _ + '<source src="' + d + '" type="audio/mpeg" />'),
                null != u && (_ = _ + '<source src="' + u + '" type="audio/ogg" />')),
                _ = _ + "</" + v + ">";
                var b = "";
                ...
                a.find(v).each(function(e) {
                    ...
                    1 != i.parent().data("metaloaded") && I(this, "loadedmetadata", (Q(t = a, n),
                    void L.resetVideo(t, n)))
                });
                break;
            case "youtube":
                f = "https",
                ...
                var C = r.split("origin=" + f + "://")
                  , k = "";
                1 < C.length ? (k = C[0] + "origin=" + f + "://",
                self.location.href.match(/www/gi) && !C[1].match(/www/gi) && (k += "www."),
                k += C[1]) : k = r;
            ...
            case "vimeo":
                f = "https",
                a.data("videomarkup", '<iframe src="' + f + "://player.vimeo.com/video/" + o + "?" + r + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="opacity:0;visibility:hidden;width:100%;height:100%"></iframe>')
            }
            var j = O && "on" == a.data("noposteronmobile");
            if (null != i.videoposter && 2 < i.videoposter.length && !j)
                0 == a.find(".tp-videoposter").length && a.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-image:url(' + i.videoposter + '); background-size:cover;background-position:center center;"></div>'),
                ...
                if (O && 1 == a.data("disablevideoonmobile"))
                    return !1;
                0 != a.find("iframe").length || "youtube" != m && "vimeo" != m || (a.removeData("vimeoplayer"),
            ...
            1 == a.data("bgvideo") && (a.data("ytid") ? punchgs.TweenLite.set(a.find("iframe"), {
                opacity: 0
    ...
    var I = function(e, t, i) {
      ...
      , A = function(o, n, e) {
        ...
        _(n, o),
        t.attr("id", i),
        e && o.data("startvideonow", !0),
        1 !== o.data("videolistenerexist"))
            switch (l.videotype) {
            case "youtube":
                    ...
                    events: {
                        onStateChange: function(e) {
                            ...
                            if (e.data == YT.PlayerState.PLAYING)
                                ...
                                "mute" == o.data("volume") || L.lastToggleState(o.data("videomutetoggledby")) || !0 === n.globalmute ? d.mute() : (d.unMute(),
                                d.setVolume(parseInt(o.data("volume"), 0) || 75)),
                                n.videoplaying = !0,
                                T(o, n),
                                ...
                                -1 != e.data && 3 != e.data && (n.videoplaying = !1,
                                n.tonpause = !1,
                                C(o, n),
                                ...
                                0 == e.data && 1 == o.data("nextslideatend") ? (b(),
                        ...
                        onReady: function(e) {
                            var t, i = L.is_mobile(), a = o.hasClass("tp-videolayer");
                            if (i || L.isSafari11()) {
                                var n = a && "off" !== o.data("autoplay");
                                (o.hasClass("rs-background-video-layer") || n) && (i && a || (t = !0,
                                d.setVolume(0),
                                o.data("volume", "mute"),
                                d.mute(),
                                clearTimeout(o.data("mobilevideotimr")),
                                o.data("mobilevideotimr", setTimeout(function() {
                                    d.playVideo()
                                }, 500))))
                            }
                            t || "mute" != o.data("volume") || (d.setVolume(0),
                            d.mute());
                            var r = l.videorate;
                            if (o.data("videostart"),
                ...
                break;
            case "vimeo":
                for (var a, c = t.attr("src"), u = {}, h = c, p = /([^&=]+)=([^&]*)/g; a = p.exec(h); )
                ...
                (g = "on" === g || "true" === g || !0 === g) && m && (c += "?autoplay=1&autopause=0&muted=1&background=1&playsinline=1",
                o.data({
                    vimeoplaysinline: !0,
                    volume: "mute"
                })),
                ...
                d = o.find("iframe")[0],
                jQuery("#" + i),
                o.data("vimeoplayer") ? y = o.data("vimeoplayer") : (y = new Vimeo.Player(i),
                o.data("vimeoplayer", y)),
                y.on("loaded", function(e) {
                    var t = {};
                    y.getVideoWidth().then(function(e) {
                        t.width = e,
                        void 0 !== t.width && void 0 !== t.height && (o.data("aspectratio", t.width + ":" + t.height),
                        o.data("vimeoplayerloaded", !0),
                        _(n, o))
                    }),
                ...
                y.on("play", function(e) {
                    ...
                    T(o, n),
                    s ? n.c.trigger("stoptimer") : n.videoplaying = !1,
                    o.data("vimeoplaysinline") || ("mute" == o.data("volume") || L.lastToggleState(o.data("videomutetoggledby")) || !0 === n.globalmute ? y.setVolume(0) : y.setVolume(parseInt(o.data("volume"), 0) / 100 || .75),
                    L.toggleState(l.videotoggledby))
                }),
                y.on("timeupdate", function(e) {
                    var t = R(o.data("videoendat"));
                    if (o.data("currenttime", e.seconds),
                    0 != t && Math.abs(t - e.seconds) < 1 && t > e.seconds && 1 != o.data("nextslidecalled"))
                        if (r) {
                            y.play();
                ...
                o.data("startvideonow") && (y.play(),
                -1 != (v = R(o.data("videostartat"))) && y.setCurrentTime(v)),
                o.data("videolistenerexist", 1)
            }
        else {
      ...
      , Q = function(n, r, e) {
        if (O && 1 == n.data("disablevideoonmobile"))
            return !1;
        var s = n.data()
        ...
        null == i.attr("control") && (0 != n.find(".tp-video-play-button").length || O || n.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'),
        ...
        1 == n.data("forcecover") || n.hasClass("fullscreenvideo") || 1 == n.data("bgvideo"))
            if (1 == n.data("forcecover") || 1 == n.data("bgvideo")) {
                ...
                void 0 !== c && 1 != c.split(":").length || n.data("aspectratio", "16:9"),
                L.prepareCoveredVideo(r, n)
            } else
                a.addClass("fullscreenvideo");
        ...
        I(f, "mousedown", function() {
            n.addClass("seekbardragged"),
            o.pause()
        }),
        I(f, "mouseup", function() {
            n.removeClass("seekbardragged"),
            o.play()
        })),
        ...
        I(o, "timeupdate", function() {
            var e = 100 / o.duration * o.currentTime
              ...
              , i = o.currentTime;
            if (null != f && (f.value = e),
            0 != t && -1 != t && Math.abs(t - i) <= .3 && i < t && 1 != n.data("nextslidecalled"))
                if (l) {
                    o.play();
                    var a = R(n.data("videostartat"));
                    -1 != a && (o.currentTime = a)
                } else
                    1 == n.data("nextslideatend") && (n.data("nextslideatend-triggered", 1),
        ...
        I(o, "play", function() {
            ...
            L.is_mobile() || L.isSafari11() || (!0 === r.globalmute ? o.muted = !0 : o.muted = !1,
            1 < e && (e /= 100),
            "mute" == e ? o.muted = !0 : null != e && (o.volume = e)),
            n.addClass("videoisplaying");
            var t = "html5" == s.audio ? "audio" : "video";
            T(n, r),
            d && "audio" != t ? (r.videoplaying = !0,
            r.c.trigger("stoptimer"),
            r.c.trigger("revolution.slide.onvideoplay", w(o, "html5", s))) : (r.videoplaying = !1,
            "audio" != t && r.c.trigger("starttimer"),
            r.c.trigger("revolution.slide.onvideostop", w(o, "html5", s))),
            ...
            null != i && (i.innerHTML = "Pause"),
            null != a && o.muted && (a.innerHTML = "Unmute"),
            L.toggleState(s.videotoggledby)
        }),
        I(o, "pause", function(e) {
            ...
            var i = n.find(".tp-vid-play-pause")[0];
            null != i && (i.innerHTML = "Play"),
            null != r.currentLayerVideoIsPlaying && r.currentLayerVideoIsPlaying.attr("id") != n.attr("id") || L.unToggleState(s.videotoggledby)
        }),
        I(o, "ended", function() {
            b(),
            C(n, r),
            ...
            "audio" != t && r.c.trigger("starttimer"),
            r.c.trigger("revolution.slide.onvideostop", w(o, "html5", n.data())),
            !0 === n.data("nextslideatend") && 0 < o.currentTime && (1 == !r.just_called_nextslide_at_htmltimer && (n.data("nextslideatend-triggered", 1),
            r.c.revnext(),
            r.just_called_nextslide_at_htmltimer = !0),
            setTimeout(function() {
                r.just_called_nextslide_at_htmltimer = !1
      ...
      , T = function(e, i) {
        ...
        e.data("stopallvideos") && null != i.playingvideos && 0 < i.playingvideos.length && (i.lastplayedvideos = jQuery.extend(!0, [], i.playingvideos),
